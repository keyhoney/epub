import { DomCommand, DomStyle, mimeTypes, SvgTong, SvgDom } from "./publicDictionary.js";

class AbstractNode {
  
  public static timeouts: Record<string, ReturnType<typeof window.setTimeout> | null> = {};
  public static mimeTypes: Record<string, string> = mimeTypes;
  public static mimeTypesToKind: Map<string, string> = ((): Map<string, string> => {
    const typeToExtensionMap: Map<string, string> = new Map();
    for (const extension in AbstractNode.mimeTypes) {
      const mimeType = AbstractNode.mimeTypes[extension];
      if (!typeToExtensionMap.has(mimeType)) {
        typeToExtensionMap.set(mimeType, extension);
      }
    }
    return typeToExtensionMap;
  })();
  public mimeTypes: Record<string, string> = AbstractNode.mimeTypes;
  public static colorExtended: Record<string, string> = {
    ...
    whiteLiteTransparent: "rgba(255, 255, 255, 0.4)",
    whiteLiteTransparent2: "rgba(255, 255, 255, 0.2)",
    blackTransparent: "rgba(55, 55, 55, 0.35)",
    blackTransparent2: "rgba(55, 55, 55, 0.75)",
    whiteBlurBack: "rgba(228, 228, 228, 0.7)",
    darkBlurBack: "rgba(50, 50, 50, 0.7)",
    grayBack: "#f3f3f3",
    gray0_5: "#fafafa",
    gray0: "#f7f7f7",
    gray1_5: "#f5f5f5",
    ...
    gray3: "#dddddd",
    gray3_5: "#d8d8d8",
    gray3_layer: "rgba(221, 221, 221, 0.32)",
    gray4: "#cccccc",
    gray5: "#aaaaaa",
    gray6: "#e7e7e7",
    gray7: "#a4a4a4",
    ...
    mintTransparent: "rgba(98, 168, 233, 0.1)",
    mintTransparent2: "linear-gradient(138deg, rgba(98, 168, 233, 0.4) 0%, rgba(98, 168, 233, 0.7) 100%)",
    mintTransparent3: "linear-gradient(138deg, rgba(98, 168, 233, 0.6) 0%, rgba(98, 168, 233, 0.85) 100%)",
    mintTransparentGradient: "linear-gradient(0deg, rgba(98, 168, 233, 0.1) 0%, rgba(98, 168, 233, 0.23) 100%)",
    mintDeactive: "rgba(195, 232, 241, 1)",
    mintSharp: "#62A8E9",
    mintDarkLight: "#A4C7EA",
    mintDarkWhiteLight: "#c8e2fa6a",
    mintDarkDarkLight: "#5794DB",
    mintLight: "#daebf504",
    mintWhite: "#E7F4F6",
    mintDark: "#006BD2",
    mintBlack: "rgba(0, 90, 160, 1)",
    mintDarkBlack: "rgba(5, 10, 14, 1)",
    mintBlue: "rgba(0,107,210,1)",
    ahhopeBlueDeactive: "rgba(217, 230, 241, 1)",
    ahhopeBlueLight: "rgb(225, 235, 245)",
    ahhopeBlue: "#ADC9E3",
    ahhopeBlueDark: "#86aed4ff",
    ahhopeBlueDim: "#478bc7ff",
    ahhopeBlueFocus: "#3386D4",
    baseBlue: "rgba(25, 170, 255, 1)",
    baseBlueTransparent: "rgba(25, 170, 255, 0.4)",
    gradientBaseBlue: "linear-gradient(138deg, rgba(25, 170, 255, 1) 0%, rgba(208, 238, 255, 0.7) 100%)",
    gradientBaseBlue2: "linear-gradient(-48deg, rgba(25, 170, 255, 0.9) 0%, rgb(105, 190, 255) 100%)",
    gradientBaseBlueWhite: "linear-gradient(138deg, rgba(163, 221, 255, 0.8) 0%, rgba(238, 249, 254, 0.9) 100%)",
    gradientMintMiddle: "linear-gradient(138deg, rgba(98, 168, 233,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientMintLight: "linear-gradient(138deg, rgba(27,168,255,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientMintWhite: "linear-gradient(138deg, rgba(0,130,210,0.3) 0%, rgba(0,179,207,0.3) 100%)",
    gradientMintDark: "linear-gradient(182deg, rgba(0, 110, 180, 1) 0%, rgba(0, 130, 190, 1) 100%)",
    gradientMintBlack: "linear-gradient(180deg, rgba(0, 90, 160, 1) 0%, rgba(0, 80, 140, 1) 100%)",
    gradientSky: "linear-gradient(138deg, rgba(98, 168, 233,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientSky2: "linear-gradient(138deg, rgba(98, 168, 233,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientMint: "linear-gradient(138deg, rgba(0,130,210,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientMintReverse: "linear-gradient(48deg, rgba(0,130,210,1) 0%, rgba(98, 168, 233,1) 100%)",
    gradientMint2: "linear-gradient(138deg, rgba(0,130,210,1) 0%, rgba(98, 168, 233,0.5) 100%)",
    backgroundMint: "linear-gradient(138deg, rgba(0,130,210,0.2) 0%, rgba(98, 168, 233,0.8) 100%)",
    backgroundWhite: "linear-gradient(138deg, rgba(100,100,100,0.2) 0%, rgba(100,100,100,0.9) 100%)",
    darkBlack: "#303030",
    darkDarkBlack: "#252525",
    realBlack: "#202020",
    darkRealBlack: "#1c1c1c",
    darkDarkRealBlack: "#141414",
    ...
    middleGreen: "#83cea7",
    liteGreen: "#f0f9f5",
    gradientWhiteWhiteGray: "linear-gradient(254deg, rgba(243, 243, 243, 0.94) 0%, rgba(248, 248, 248, 0.95) 100%)",
    gradientWhiteGray: "linear-gradient(254deg, rgba(236, 236, 236, 0.94) 0%, rgba(240, 240, 240, 0.95) 100%)",
    gradientWhiteGray2: "linear-gradient(254deg, rgba(230, 230, 230, 0.4) 0%, rgba(255, 255, 255, 0.65) 100%)",
    ...
    gradientBlack2: "linear-gradient(256deg, rgba(2, 2, 2, 0.95) 0%, rgba(6, 6, 6, 0.84) 100%)",
    ...
    gradientPurple: "linear-gradient(200deg, rgba(161, 166, 223, 1) 0%, rgba(161, 166, 223, 0.65) 100%)",
    gradientGrayTransparent: "linear-gradient(0deg, rgba(205,205,205,0.7) 0%, rgba(205,205,205,0.3) 100%)",
    gradientTransparent: "linear-gradient(0deg, rgba(255,255,255,0.7) 0%, rgba(235,235,235,0.3) 100%)",
    gradientTransparent2: "linear-gradient(0deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.5) 100%)",
    gradientTransparent3: "linear-gradient(0deg, rgba(255,255,255,0.6) 0%, rgba(235,235,235,0.15) 100%)",
    gradientWhiteTransparent: "linear-gradient(0deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.6) 100%)",
    mintFolder: "rgba(166, 212, 234, 1)",
    gradientMintFolder: "linear-gradient(to bottom, rgba(166, 212, 234, 0.8) 0%, rgba(166, 212, 234, 0.1) 100%)",
    gradientMintFolder2: "linear-gradient(to bottom, rgba(166, 212, 234, 0.15) 0%, rgba(166, 212, 234, 0.5) 100%)",
    red: "#B32737",
    yellow: "#F2AB63",
    purple: "#dcbdfb",
    purpleDark: "#BA8AEA",
    purpleDimDark: "#4a5191",
    purpleLogo: "#a1a6df",
    purpleLight: "#bcc2e8",
    darkRed: "#d13939",
    blueWhite: "#E7F3FB",
    ...
    roseDark: "#CD7156",
    leaf: "#CAC9A1",
    gradientPinkBlue: "linear-gradient(138deg, #f2c5e6 0%, #8db8f7 100%)",
    pinkBeige: "rgba(229, 161, 153, 1)",
    pinkBeigeLight: "rgba(250, 224, 216, 1)",
    pinkBeigeDark: "rgba(204, 127, 124, 1)",
    gradientBeige: "linear-gradient(120deg, rgba(204, 127, 124, 1) 0%, rgba(250, 224, 216, 1) 100%)",
    gradientBeige2: "linear-gradient(120deg, rgba(229, 161, 153, 1) 0%, rgba(250, 224, 216, 1) 100%)",
    gradientBeige3: "linear-gradient(120deg, rgba(255, 255, 255, 1) 0%, rgba(250, 224, 216, 1) 100%)",
    macRed: "#FF5C5F",
    macYellow: "#fedd5a",
    macGreen: "#34C759",
  };
  public colorExtended: Record<string, string> = AbstractNode.colorExtended;
  public static svgMaker: Record<string, (...args: any[]) => string> = {
    ...
    colorPicker: (color: string) => { return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M160.5 8.1c-13.8 1.7-26 7.6-36.5 17.6l-6.8 6.3-4.3-2.5c-8.5-4.8-19-2.6-26.4 5.7-7.1 7.8-8.2 14.9-3.8 23.9 2.2 4.3 11.4 14.1 47.7 50.5 33.1 33.1 46.3 45.6 49.7 47.2 7.9 3.8 15.5 2.5 23.3-4 8.2-6.9 10.7-16.8 6.5-25.5l-2.1-4.4 6.8-7.2c12.1-12.7 17.6-26.4 17.6-43.7 0-14.2-3.4-25.5-11.3-37.1-4.5-6.7-13.4-15-20.3-19-11.1-6.4-27.2-9.5-40.1-7.8M52.4 103.2c-28.3 28.7-32.1 33.5-34.9 44.3-1.8 7.1-1.9 10.7-.4 23l1.2 9.3-5.4 13.4C5.7 211 6 216.5 14.6 225.4c8.5 8.8 13.9 9 32 1.3 13-5.6 13.3-5.6 19-4.7 11 1.8 23.6 1.3 30.8-1.3 10-3.7 17.2-9.7 43.4-35.9l24.3-24.4-42.3-42.2C98.6 95 79.6 76 79.5 76s-12.2 12.3-27.1 27.2"/></svg>`; },
    loadingIcon: function (color: string = AbstractNode.colorExtended.darkShadow, color2: string = AbstractNode.colorExtended.black): string {
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 566.929 566.929"><path d="M196.13 552.859c-23.91-7.75-37.01-33.409-29.26-57.31l0 0c7.74-23.9 33.4-37.01 57.31-29.26l0 0c23.9 7.74 37 33.399 29.26 57.31l0 0c-6.24 19.25-24.08 31.49-43.28 31.49l0 0C205.52 555.09 200.79 554.37 196.13 552.859z" fill="${ color }"/><path d="M313.729 523.569C305.96 499.67 319.04 474 342.939 466.229l0 0c23.891-7.77 49.561 5.301 57.33 29.2l0 0c7.771 23.9-5.3 49.57-29.2 57.34l0 0c-4.67 1.521-9.409 2.24-14.069 2.24l0 0C337.819 555.01 319.979 542.79 313.729 523.569z" fill="${ color2 }"/><path d="M54.55 450.109c-14.81-20.3-10.35-48.76 9.96-63.569l0 0c20.3-14.8 48.77-10.34 63.57 9.97l0 0c14.8 20.3 10.34 48.76-9.96 63.56l0 0c-8.09 5.9-17.47 8.74-26.77 8.74l0 0C77.31 468.81 63.45 462.33 54.55 450.109z" fill="${ color }"/><path d="M449 459.899c-20.33-14.779-24.82-43.239-10.03-63.56l0 0c14.78-20.32 43.23-24.81 63.561-10.03l0 0c20.319 14.78 24.81 43.24 10.029 63.561l0 0c-8.91 12.239-22.779 18.739-36.84 18.739l0 0C466.439 468.609 457.069 465.78 449 459.899z" fill="${ color2 }"/><path d="M0.33 283.77C0.3 258.64 20.65 238.25 45.78 238.22l0 0c25.13-0.03 45.52 20.32 45.55 45.45l0 0C91.35 308.8 71 329.189 45.88 329.22l0 0c-0.02 0-0.03 0-0.05 0l0 0C20.72 329.22 0.35 308.88 0.33 283.77z" fill="${ color }"/><path d="M475.6 283.46L475.6 283.46c0-0.01 0-0.03 0-0.05l0 0c0-0.12 0-0.24 0-0.36l0 0C475.55 257.92 495.87 237.51 521 237.45l0 0c25.13-0.05 45.55 20.28 45.6 45.41l0 0c0 0.12 0 0.24 0 0.36l0 0c0 0.08 0 0.16 0 0.24l0 0c0 25.13-20.37 45.5-45.5 45.5l0 0C495.97 328.96 475.6 308.59 475.6 283.46z" fill="${ color2 }"/><path d="M0.33 283.76v0.01l0 0 0 0 0 0C0.33 283.76 0.33 283.76 0.33 283.76z" fill="${ color }"/><path d="M64.29 180.85c-20.34-14.76-24.86-43.21-10.1-63.55l0 0C68.95 96.96 97.41 92.44 117.74 107.2l0 0c20.34 14.76 24.86 43.22 10.1 63.55l0 0c-8.9 12.27-22.78 18.78-36.86 18.78l0 0C81.71 189.53 72.36 186.71 64.29 180.85z" fill="${ color }"/><path d="M438.729 170.26c-14.83-20.29-10.399-48.76 9.891-63.59l0 0c20.29-14.82 48.76-10.39 63.58 9.9l0 0 0 0 0 0c14.83 20.29 10.399 48.75-9.891 63.58l0 0c-8.1 5.92-17.5 8.77-26.81 8.77l0 0C461.47 188.92 447.64 182.45 438.729 170.26z" fill="${ color }"/><path d="M166.43 71.62C158.63 47.73 171.67 22.05 195.57 14.25l0 0c23.89-7.8 49.57 5.25 57.37 29.14l0 0c7.79 23.89-5.26 49.57-29.14 57.37l0 0c-4.69 1.53-9.45 2.26-14.13 2.26l0 0C190.52 103.02 172.69 90.82 166.43 71.62z" fill="${ color }"/><path d="M342.56 100.57h-0.01c-23.91-7.72-37.04-33.36-29.32-57.27l0 0C320.95 19.38 346.6 6.25 370.51 13.98l0 0 0 0 0 0C394.42 21.69 407.55 47.34 399.83 71.25l0 0c-6.221 19.27-24.07 31.54-43.29 31.54l0 0C351.91 102.79 347.2 102.07 342.56 100.57z" fill="${ color }"/></svg>`;
    },
    ...
    mypage: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 240.000000 240.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,240) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M818 2219 c-10 -5 -72 -81 -139 -168 l-120 -159 -182 -4 c-204 -4 -234 -12 -300 -76 -21 -20 -46 -60 -57 -89 -19 -52 -20 -79 -20 -695 0 -466 3 -651 12 -680 18 -61 89 -133 154 -157 54 -21 70 -21 1042 -21 l987 0 50 24 c58 27 99 65 129 121 21 40 21 47 24 700 3 722 4 705 -56 776 -65 78 -139 99 -351 99 l-148 0 -119 157 c-65 87 -130 163 -144 170 -32 16 -735 18 -762 2z m105 -781 c30 -15 57 -70 57 -115 0 -74 -82 -137 -155 -119 -61 15 -107 97 -91 159 18 73 117 112 189 75z m695 -12 c79 -71 61 -182 -34 -215 -52 -18 -88 -9 -131 34 -29 29 -33 40 -33 83 0 61 25 96 83 116 47 16 85 10 115 -18z m-735 -536 c97 -70 160 -92 286 -98 158 -7 252 21 363 109 66 52 116 54 159 8 22 -24 29 -41 29 -72 0 -36 -6 -47 -52 -91 -130 -125 -348 -190 -557 -166 -154 17 -279 71 -373 160 -53 51 -58 59 -58 99 0 35 6 48 31 72 48 45 89 40 172 -21z"/></g></svg>`;
    },
    homeIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 549 551" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M0,272.513c-0,-18.235 7.652,-35.634 21.092,-47.958c53.634,-49.18 194.143,-178.019 238.968,-219.122c7.895,-7.239 20.016,-7.239 27.912,0c44.825,41.103 185.333,169.942 238.967,219.122c13.44,12.324 21.092,29.723 21.092,47.958c0,49.501 0,152.103 0,217.821c0,15.92 -6.324,31.188 -17.581,42.445c-11.257,11.257 -26.525,17.581 -42.445,17.581c-58.461,0 -141.767,0 -164.68,0c-3.331,0 -6.031,-2.7 -6.031,-6.031c-0,-21.534 -0,-95.892 -0,-143.744c-0,-23.201 -18.808,-42.009 -42.008,-42.009c-0.847,0 -1.694,0 -2.54,0c-23.201,0 -42.008,18.808 -42.008,42.009c-0,47.852 -0,122.21 -0,143.744c-0,3.331 -2.701,6.031 -6.031,6.031c-22.914,0 -106.22,0 -164.681,0c-15.92,0 -31.188,-6.324 -42.445,-17.581c-11.257,-11.257 -17.581,-26.525 -17.581,-42.445c0,-65.718 0,-168.32 0,-217.821Z"/></svg>`;
    },
    aboutIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 541 551" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M19.623,550.36c-10.837,0 -19.623,-8.778 -19.623,-19.606l0,-465.943c-0,-17.189 6.834,-33.674 18.999,-45.828c12.165,-12.155 28.664,-18.983 45.868,-18.983l207.755,0c17.203,-0 33.702,6.828 45.867,18.983c12.165,12.154 18.999,28.639 18.999,45.828c0,0 0,434.934 0,481.52c0,2.225 -1.803,4.029 -4.029,4.029c-22.604,0 -132.658,0 -132.658,0l0,-97.084c0,-17.419 -14.132,-31.54 -31.566,-31.54l-0.982,0c-17.433,0 -31.566,14.121 -31.566,31.54l-0,97.084l-117.064,0Zm254.916,-277.541c-0,-17.894 -14.541,-32.422 -32.45,-32.422c-17.91,-0 -32.45,14.528 -32.45,32.422l-0,44.197c-0,17.894 14.54,32.422 32.45,32.422c17.909,0 32.45,-14.528 32.45,-32.422l-0,-44.197Zm-211.539,0l0,44.197c0,17.894 14.541,32.422 32.45,32.422c17.91,0 32.451,-14.528 32.451,-32.422l-0,-44.197c-0,-17.894 -14.541,-32.422 -32.451,-32.422c-17.909,-0 -32.45,14.528 -32.45,32.422Zm0,-146.255l0,44.197c0,17.894 14.541,32.422 32.45,32.422c17.91,0 32.451,-14.528 32.451,-32.422l-0,-44.197c-0,-17.895 -14.541,-32.423 -32.451,-32.423c-17.909,0 -32.45,14.528 -32.45,32.423Zm211.539,-0c-0,-17.895 -14.541,-32.423 -32.45,-32.423c-17.91,0 -32.45,14.528 -32.45,32.423l-0,44.197c-0,17.894 14.54,32.422 32.45,32.422c17.909,0 32.45,-14.528 32.45,-32.422l-0,-44.197Zm196.085,62.438c18.65,-0 36.536,7.409 49.724,20.596c13.188,13.188 20.597,31.075 20.597,49.725l-0,267.171c-0,13.181 -10.685,23.866 -23.866,23.866l-142.726,0c-1.069,0 -2.093,-0.424 -2.849,-1.18c-0.756,-0.755 -1.18,-1.78 -1.18,-2.849c-0,-37.289 -0,-321.594 -0,-354.271c-0,-0.811 0.322,-1.589 0.896,-2.163c0.573,-0.573 1.351,-0.895 2.162,-0.895l97.242,-0Z"/></svg>`;
    },
    ...
    toggleIcon: function (color: string): string {
      return `<svg viewBox="0 0 1559 1772" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M134.783,1759.48l1378.43,-795.837c59.904,-34.588 59.904,-121.05 -0.001,-155.638l-1378.43,-795.833c-59.904,-34.583 -134.783,8.65 -134.783,77.821l-0,1591.67c-0,69.171 74.879,112.404 134.783,77.816Z" /></svg>`;
    },
    ...
    sendUpArrow: function (color: string): string {
      return `<svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 14 14"><path d="M7 12L7 2M2.5 6.5L7 2L11.5 6.5" stroke="${ color }" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>/></svg>`;
    },
    smileDocuments: function (color: string): string {
      return `<svg viewBox="0 0 2481 2481" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M1408.93,2453.17c-0,14.991 -12.153,27.144 -27.144,27.144l-1108.95,-0c-150.582,-0 -272.835,-122.253 -272.835,-272.835l-0,-1934.64c-0,-150.582 122.253,-272.835 272.835,-272.835l1934.64,-0c150.582,-0 272.835,122.253 272.835,272.835l-0,1108.95c-0,14.991 -12.153,27.144 -27.144,27.144l-747.346,-0c-78.741,-0 -154.256,31.28 -209.934,86.958c-55.678,55.678 -86.958,131.193 -86.958,209.934l-0,747.346Zm-613.534,-1020.86l0.168,0.657c327.71,-47.471 588.422,-303.054 643.607,-628.217l-0.489,-0.146c1.16,-6.194 1.767,-12.581 1.767,-19.109c-0,-57.034 -46.305,-103.338 -103.338,-103.338c-49.317,-0 -90.611,34.62 -100.883,80.862l-0.244,0c-37.59,239.641 -228.044,428.85 -468.299,464.563c-2.645,0.27 -5.26,0.641 -7.842,1.108c-48.23,8.722 -84.86,50.961 -84.86,101.688c0,57.034 46.305,103.338 103.338,103.338c5.816,0 11.52,-0.481 17.075,-1.406Zm156.993,-1045.52c-80.874,-0 -146.533,65.659 -146.533,146.532c0,80.874 65.659,146.533 146.533,146.533c80.873,-0 146.532,-65.659 146.532,-146.533c0,-80.873 -65.659,-146.532 -146.532,-146.532Zm-420.235,376.521c-80.874,-0 -146.533,65.659 -146.533,146.532c0,80.874 65.659,146.533 146.533,146.533c80.873,-0 146.532,-65.659 146.532,-146.533c0,-80.873 -65.659,-146.532 -146.532,-146.532Zm1923.38,769.9c13.687,-0 24.782,11.095 24.782,24.782l-0,61.13c-0,57.954 -23.022,113.535 -64.002,154.515l-642.673,642.673c-40.98,40.98 -96.561,64.002 -154.515,64.002l-61.13,-0c-13.687,-0 -24.782,-11.095 -24.782,-24.782l-0,-741.236c-0,-48.026 19.078,-94.086 53.038,-128.046c33.96,-33.96 80.02,-53.038 128.046,-53.038l741.236,-0Z"/></svg>`;
    },
    leftWing: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 1008 1081" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"><clipPath id="_clip1222"><rect x="0" y="0" width="1007.48" height="1080.709"/></clipPath><g clip-path="url(#_clip1222)"><path fill="${ color }" d="M0,1080.156l0,-80.48c-0,-107.943 25.225,-214.393 73.662,-310.859l245.404,-488.734c61.59,-122.659 187.103,-200.083 324.357,-200.083l364.172,0l0,1080.156l-1007.595,-0Z"/></g></svg>`;
    },
    rightWing: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 1008 836" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/"><clipPath id="_clip1awefawefawef"><rect x="0" y="0" width="1007.48" height="835.039"/></clipPath><g clip-path="url(#_clip1awefawefawef)"><path fill="${ color }" d="M1007.595,835.519c0,0 -194.952,-388.257 -319.066,-635.436c-61.59,-122.659 -187.103,-200.083 -324.357,-200.083l-364.172,-0l0,835.519l1007.595,0"/></g></svg>`;
    },
    horizontalArrow: function (width: number, height: number, color: string = AbstractNode.colorExtended.blue, styleInjection: Record<string, string | number> | null = null): string {
      if (height === 0) {
      ...
      if (styleInjection === null || styleInjection === undefined) {
      ...
      } else if (typeof styleInjection === "object") {
        const { mediaEa } = AbstractNode;
        let thisEa: string;
        let styleString: string;
        thisEa = mediaEa();
        styleString = "";
        for (let key in styleInjection) {
          styleString += key;
          styleString += ":";
          if (typeof styleInjection[key] === "number") {
            styleString += String(styleInjection[key]) + thisEa + ";";
          } else {
            styleString += String(styleInjection[key]) + ";";
          }
        }
        return `<svg version="1.1" style="${styleString}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${calcul(x)} ${calcul(y)}" xml:space="preserve"><path fill="${color}" d="M${calcul(x)},3.36c0-0.103-0.042-0.196-0.109-0.263c0,0,0-0.001-0.001-0.002L${calcul(x - constValues[0])},0.11c-0.146-0.146-0.385-0.146-0.531,0c-0.146,0.146-0.146,0.384,0,0.53l2.346,2.345H0.375C0.168,2.985,0,3.153,0,3.36s0.168,0.375,0.375,0.375h${calcul(x - constValues[1])}L${calcul(x - constValues[2])},6.08c-0.146,0.146-0.146,0.385,0,0.531c0.073,0.073,0.17,0.109,0.266,0.109s0.192-0.036,0.266-0.109l2.985-2.986c0,0,0-0.001,0.001-0.002C${calcul(x - constValues[3])},3.556,${calcul(x)},3.463,${calcul(x)},3.36z"/></svg>`;
      } else {
        return `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${calcul(x)} ${calcul(y)}" xml:space="preserve"><path fill="${color}" d="M${calcul(x)},3.36c0-0.103-0.042-0.196-0.109-0.263c0,0,0-0.001-0.001-0.002L${calcul(x - constValues[0])},0.11c-0.146-0.146-0.385-0.146-0.531,0c-0.146,0.146-0.146,0.384,0,0.53l2.346,2.345H0.375C0.168,2.985,0,3.153,0,3.36s0.168,0.375,0.375,0.375h${calcul(x - constValues[1])}L${calcul(x - constValues[2])},6.08c-0.146,0.146-0.146,0.385,0,0.531c0.073,0.073,0.17,0.109,0.266,0.109s0.192-0.036,0.266-0.109l2.985-2.986c0,0,0-0.001,0.001-0.002C${calcul(x - constValues[3])},3.556,${calcul(x)},3.463,${calcul(x)},3.36z"/></svg>`;
      }
    },
    verticalArrow: function (width: number, height: number, color: string = AbstractNode.colorExtended.blue, styleInjection: Record<string, string | number> | null = null): string {
      if (width === 0) {
      ...
      if (styleInjection === null || styleInjection === undefined) {
        ...
        return `<svg style="${styleString}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${calcul(y)} ${calcul(x)}" xml:space="preserve"><path fill="${color}" d="M3.36,${calcul(x)}c0.103,0,0.196-0.042,0.263-0.109c0,0,0.001,0,0.002-0.001l2.985-2.985c0.146-0.146,0.146-0.385,0-0.531s-0.384-0.146-0.53,0l-2.345,2.346V0.375C3.735,0.168,3.567,0,3.36,0S2.985,0.168,2.985,0.375v${calcul(x - constValues[0])}l-2.345-2.346c-0.146-0.146-0.385-0.146-0.531,0C0.036,${calcul(x - constValues[1])},0,${calcul(x - constValues[2])},0,${calcul(x - constValues[3])}c0,0.096,0.036,0.192,0.109,0.266l2.986,2.985c0,0,0.001,0,0.002,0.001C3.164,${calcul(x - constValues[4])},3.257,${calcul(x)},3.36,${calcul(x)}z"/></svg>`;
      } else {
        return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${calcul(y)} ${calcul(x)}" xml:space="preserve"><path fill="${color}" d="M3.36,${calcul(x)}c0.103,0,0.196-0.042,0.263-0.109c0,0,0.001,0,0.002-0.001l2.985-2.985c0.146-0.146,0.146-0.385,0-0.531s-0.384-0.146-0.53,0l-2.345,2.346V0.375C3.735,0.168,3.567,0,3.36,0S2.985,0.168,2.985,0.375v${calcul(x - constValues[0])}l-2.345-2.346c-0.146-0.146-0.385-0.146-0.531,0C0.036,${calcul(x - constValues[1])},0,${calcul(x - constValues[2])},0,${calcul(x - constValues[3])}c0,0.096,0.036,0.192,0.109,0.266l2.986,2.985c0,0,0.001,0,0.002,0.001C3.164,${calcul(x - constValues[4])},3.257,${calcul(x)},3.36,${calcul(x)}z"/></svg>`;
      }
    },
    dotDotDot: function (color: string, styleInjection: Record<string, string | number> | null = null): string {
      if (styleInjection === null || styleInjection === undefined) {
        ...
        return `<svg style="${styleString}" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 336.215 72.772"><path d="M72.772,36.386c0,20.095-16.29,36.386-36.386,36.386S0,56.481,0,36.386S16.29,0,36.386,0S72.772,16.29,72.772,36.386z M168.109,0c-20.095,0-36.386,16.29-36.386,36.386s16.29,36.386,36.386,36.386s36.386-16.29,36.386-36.386S188.205,0,168.109,0z M299.829,0c-20.095,0-36.386,16.29-36.386,36.386s16.29,36.386,36.386,36.386s36.386-16.29,36.386-36.386S319.924,0,299.829,0z" fill="${color}"/></svg>`;
      } else {
        return `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 336.215 72.772"><path d="M72.772,36.386c0,20.095-16.29,36.386-36.386,36.386S0,56.481,0,36.386S16.29,0,36.386,0S72.772,16.29,72.772,36.386z M168.109,0c-20.095,0-36.386,16.29-36.386,36.386s16.29,36.386,36.386,36.386s36.386-16.29,36.386-36.386S188.205,0,168.109,0z M299.829,0c-20.095,0-36.386,16.29-36.386,36.386s16.29,36.386,36.386,36.386s36.386-16.29,36.386-36.386S319.924,0,299.829,0z" fill="${color}"/></svg>`;
      }
    },
    ...
    checkCircle: function (color: string): string {
      if (
        color === AbstractNode.colorExtended.deactive ||
        color === AbstractNode.colorExtended.gray3 ||
        color === AbstractNode.colorExtended.gray4 ||
        color === AbstractNode.colorExtended.gray5 ||
        color === AbstractNode.colorExtended.red
      ) {
        return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 247 246"><path fill="${ color }" d="M123.017,0c67.925,0 123,55.071 123,123c-0,67.942 -55.071,123 -123,123c-67.946,0 -123.017,-55.058 -123.017,-123c0,-67.929 55.071,-123 123.017,-123Zm73.945,124.916c-0,-6.021 -4.889,-10.909 -10.91,-10.909l-126.088,-0c-6.021,-0 -10.909,4.888 -10.909,10.909c-0,6.021 4.888,10.909 10.909,10.909l126.088,0c6.021,0 10.91,-4.888 10.91,-10.909Z"/></svg>`;
      } else {
    ...
    closeCircle: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 400.000000 400.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,400) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M1755 3933 c-679 -87 -1253 -492 -1558 -1100 -135 -269 -190 -512 -190 -848 0 -270 44 -522 134 -770 43 -119 137 -301 192 -373 76 -98 243 -242 282 -242 22 0 47 37 40 59 -3 11 -28 36 -54 55 -65 48 -174 165 -218 234 -150 233 -253 640 -253 991 0 140 24 342 54 466 131 533 560 1013 1096 1226 580 230 1266 146 1780 -219 128 -91 359 -322 436 -437 173 -257 266 -490 308 -778 20 -131 20 -370 1 -502 -37 -260 -132 -511 -268 -708 -387 -561 -1064 -855 -1837 -798 -168 13 -287 31 -391 62 -83 24 -101 24 -124 -1 -15 -16 -17 -26 -9 -48 11 -32 60 -51 229 -87 176 -37 287 -49 485 -49 543 -1 1033 157 1411 455 111 88 266 250 352 370 131 182 250 458 296 684 42 208 53 440 31 625 -54 444 -261 867 -571 1165 -314 302 -719 500 -1148 559 -102 15 -419 20 -506 9z"/><path fill="${ color }" d="M2589 2819 c-31 -11 -42 -31 -69 -120 -13 -42 -36 -88 -64 -123 -42 -55 -474 -516 -482 -516 -10 0 -389 313 -539 445 -253 222 -235 211 -280 172 -23 -19 -25 -26 -16 -49 10 -26 134 -169 275 -317 34 -35 142 -138 241 -229 99 -92 181 -169 183 -172 1 -3 -69 -80 -155 -170 -87 -91 -214 -230 -283 -310 -69 -80 -158 -181 -199 -225 -86 -95 -103 -124 -99 -173 2 -31 6 -36 23 -34 36 6 124 81 319 271 105 102 270 259 367 347 l176 162 174 -150 c96 -82 251 -225 345 -318 148 -147 174 -168 195 -163 72 18 67 56 -24 169 -128 160 -232 276 -395 438 l-160 159 97 116 c238 283 426 570 445 682 13 73 -24 126 -75 108z"/></g></svg>`;
    },
    pendingCircle: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 400.000000 400.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,400) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M1825 3940 c-303 -22 -654 -139 -910 -305 -321 -206 -585 -508 -746 -851 -205 -438 -221 -1001 -44 -1529 36 -108 125 -292 179 -374 47 -71 182 -206 253 -255 52 -35 89 -30 99 11 6 24 2 32 -37 63 -83 67 -188 177 -233 247 -120 186 -215 495 -245 797 -42 419 50 829 257 1151 110 172 278 356 437 480 434 339 1040 466 1575 331 469 -120 853 -387 1115 -777 340 -505 390 -1185 129 -1736 -78 -163 -173 -293 -328 -449 -104 -104 -169 -160 -248 -212 -288 -190 -620 -305 -993 -343 -252 -25 -596 -1 -785 55 -71 21 -103 20 -124 -3 -14 -16 -16 -26 -9 -48 9 -25 20 -31 119 -59 355 -102 829 -106 1204 -9 522 134 920 402 1185 800 200 298 300 620 312 995 6 202 -9 341 -57 537 -113 464 -405 874 -815 1146 -110 73 -353 194 -462 230 -275 91 -553 126 -828 107z"/><path fill="${ color }" d="M1930 2019 c-58 -5 -226 -22 -375 -39 -148 -16 -353 -34 -454 -40 -184 -11 -214 -16 -225 -45 -8 -21 9 -61 29 -69 9 -3 152 -9 318 -12 329 -7 673 8 1077 47 146 15 297 22 471 23 278 1 289 3 289 56 0 44 -26 57 -140 70 -130 15 -845 22 -990 9z"/></g></svg>`;
    },
    ...
    newWindowIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 67 67" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/"><path fill="${color}" d="M55.339,6.636l-12,0c-1.832,0 -3.318,-1.487 -3.318,-3.318c-0,-1.831 1.486,-3.318 3.318,-3.318l20.01,0c0.893,0 1.729,0.356 2.346,0.972c0.616,0.616 0.971,1.452 0.971,2.346l0.001,20.01c-0,1.831 -1.487,3.318 -3.318,3.318c-1.832,0 -3.318,-1.487 -3.318,-3.318l-0,-12l-24.351,24.352c-1.295,1.294 -3.398,1.294 -4.693,-0c-1.295,-1.295 -1.295,-3.398 0,-4.693l24.352,-24.351Zm4.692,30.032c-0,-1.831 1.486,-3.318 3.318,-3.318c1.831,0 3.318,1.487 3.318,3.318l-0,20.011c-0,5.516 -4.472,9.988 -9.988,9.988l-46.691,-0c-5.516,-0 -9.988,-4.472 -9.988,-9.988l0,-46.691c0,-5.516 4.472,-9.988 9.988,-9.988l20.01,0c1.831,0 3.318,1.487 3.318,3.318c0,1.831 -1.487,3.318 -3.318,3.318l-20.01,0c-1.851,0 -3.352,1.501 -3.352,3.352l0,46.691c0,1.851 1.501,3.352 3.352,3.352l46.691,-0c1.851,-0 3.352,-1.501 3.352,-3.352l-0,-20.011Z"/></svg>`;
    },
    reverseRadius: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 1162.000000 1148.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,1148) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M10357 11198 c-32 -1364 -357 -2760 -939 -4028 -741 -1614 -1907 -3036 -3348 -4081 -636 -461 -1246 -809 -1960 -1119 -605 -262 -1139 -441 -1754 -586 -718 -169 -1545 -273 -2183 -274 l-173 0 0 -555 0 -555 5810 0 5810 0 0 5740 0 5740 -628 0 -629 0 -6 -282z"/></g></svg>`;
    },
    resetIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 242 280" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/"><path fill="${color}" d="M120.749,37.67c66.642,-0 120.748,54.105 120.748,120.748c0,66.643 -54.106,120.749 -120.748,120.749c-66.643,-0 -120.749,-54.106 -120.749,-120.749c0,-7.515 6.101,-13.616 13.616,-13.616c7.516,-0 13.617,6.101 13.617,13.616c-0,51.613 41.903,93.516 93.516,93.516c51.612,-0 93.515,-41.903 93.515,-93.516c0,-51.613 -41.903,-93.516 -93.515,-93.516l-41.41,0l14.213,14.213c5.314,5.314 5.314,13.943 -0,19.257c-5.314,5.314 -13.943,5.314 -19.257,-0l-37.456,-37.459c-2.562,-2.561 -3.989,-6.006 -3.989,-9.627c-0,-3.621 1.427,-7.066 3.989,-9.627l37.456,-37.459c5.314,-5.314 13.943,-5.314 19.257,0c5.314,5.314 5.314,13.943 -0,19.257l-14.213,14.213l41.41,-0Z"/></svg>`;
    },
    ...
    earthIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 8859 8859" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M108.654,4226.29c-30.166,-0 -58.979,-12.513 -79.571,-34.555c-20.591,-22.041 -31.116,-51.637 -29.066,-81.733c142.108,-1987.67 1600.58,-3614.37 3509.05,-4015.2c-526.833,867.667 -1140.17,2246.59 -1200.3,4026.06c-1.867,58.741 -50.025,105.395 -108.796,105.395c-382.867,0.034 -1693.57,0.034 -2091.32,0.034Zm5233.83,-4131.48c1908.47,400.829 3366.95,2027.52 3508.99,4015.2c2.05,30.08 -8.47,59.659 -29.054,81.692c-20.579,22.029 -49.375,34.533 -79.525,34.533c-397.746,0.059 -1708.45,0.059 -2091.32,0.059c-58.792,-0 -106.967,-46.667 -108.834,-105.43c-60.1,-1779.46 -673.433,-3158.39 -1200.27,-4026.05Zm3400.42,4537.17c30.167,0 58.979,12.512 79.571,34.554c20.592,22.042 31.117,51.638 29.067,81.733c-141.829,1983.76 -1594.85,3607.97 -3497.79,4012.82c524.971,-790.942 1125.62,-2104.18 1188.45,-4023.62c1.842,-58.767 50.013,-105.45 108.809,-105.45c382.958,-0.029 1694.08,-0.029 2091.89,-0.029Zm-5245.08,4129.1c-1902.94,-404.85 -3355.96,-2029.05 -3497.73,-4012.82c-2.05,-30.079 8.47,-59.658 29.054,-81.687c20.579,-22.034 49.375,-34.538 79.525,-34.538c397.816,-0.058 1708.93,-0.058 2091.89,-0.058c58.813,-0 106.996,46.696 108.838,105.479c62.804,1919.45 663.454,3232.68 1188.42,4023.62Zm451.812,-8605.88c57.642,-89.046 154.63,-144.892 260.58,-150.042c71.433,-3.416 143.304,-5.145 215.579,-5.145c72.275,-0 144.146,1.729 215.579,5.145c105.95,5.15 202.937,60.996 260.579,150.042c513.508,802.867 1168.61,2165.25 1233.94,3958.49c1.008,29.495 -10,58.141 -30.509,79.362c-20.508,21.225 -48.758,33.208 -78.27,33.208c-518.817,0.046 -2683.83,0.046 -3202.64,0.046c-29.525,0 -57.783,-11.987 -78.304,-33.221c-20.517,-21.233 -31.529,-49.887 -30.521,-79.395c65.379,-1793.24 720.479,-3155.62 1233.99,-3958.49Zm935.767,8566.04c-56.996,78.658 -146.612,127.187 -243.633,131.933c-71.563,3.379 -143.567,5.113 -215.975,5.113c-72.409,-0 -144.413,-1.734 -215.975,-5.167c-97,-4.742 -186.609,-53.262 -243.592,-131.908c-510.867,-706.017 -1180.39,-1997.91 -1249.93,-3976.66c-0.996,-29.487 10.025,-58.116 30.533,-79.329c20.508,-21.212 48.75,-33.191 78.254,-33.191c518.667,-0.038 2682.76,-0.038 3201.43,-0.038c29.517,0 57.767,11.979 78.284,33.2c20.516,21.221 31.541,49.858 30.545,79.358c-69.587,1978.75 -739.108,3270.64 -1249.93,3976.69Z"/></svg>`;
    },
    ...
    createEpub: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M106.2 12.9c-8.3 4.1-18.7 10.6-23 14.5-1.3 1.2-3.6 4.3-5 7.1-2.6 4.9-2.7 5.5-2.7 23 0 16.9.1 18.3 2.4 22.8 2.5 5.1 8.6 10.6 17.2 15.4l4.9 2.8v31.1l-13.1 7.5-13.2 7.5-10.4-5.3c-15.1-7.7-20.4-7.3-38.3 3.3-10.3 6.1-16.5 11.5-19.1 16.6-3.7 7.3-4.7 31.4-1.7 43.1 1.9 7.6 12.4 16.2 30.1 24.8 12.7 6.1 18.8 5.3 35.7-4.7 10.3-6.1 16.5-11.5 19.1-16.7 1.8-3.4 3.7-15.6 3.9-23.8 0-1.1 4.9-4.5 13.3-9.3 7.3-4.2 13.6-7.6 14-7.6.3 0 6.4 3.4 13.5 7.5l12.9 7.5.7 6.1c.3 3.4.6 7.6.6 9.3 0 11.8 9 20.9 31.3 31.7 12.7 6.1 18.8 5.3 35.7-4.7 10.3-6.1 16.5-11.5 19.1-16.7 4.2-8.1 4.6-38.7.6-46.3-3.4-6.4-13.7-14.1-28.9-21.5-12.3-5.9-18.5-5.3-32.9 3l-6.7 3.9-13.1-7.5-13.1-7.5V99.3l7.9-5.2c9.5-6.2 11.3-8.2 14.3-14.6 1.9-4.2 2.3-7.2 2.6-19.1.7-23.5-1.6-29.2-15.5-38.3-12.9-8.5-21.6-12.5-28.7-12.9-5.5-.3-6.9.1-14.4 3.7"/></svg>`,
    createLayout: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M41 8c-13.2.9-19.3 3.3-25.4 10.1C8.8 25.6 8.2 29 7.5 61.5c-.3 15.4-.2 37 .3 48 .7 17.5 1.1 20.7 3.1 25.2 2.6 5.9 9.1 12.4 14.8 14.8 10.5 4.4 58.5 4 69.1-.5 6.9-3 13.4-10.2 15.5-17.2 2.1-6.8 3.2-52.7 1.9-81.3-.7-17.5-1.1-20.7-3.1-25.2-2.6-5.9-9.1-12.4-14.8-14.8-6.8-2.9-31-4-53.3-2.5m114.5-.1c-8.3.6-10.9 1.2-15.5 3.7-8 4.3-11 9.1-12.2 19.6-1.2 10.3.1 23.1 2.9 28.5 2.4 4.6 9 9.9 14.1 11.2 5.7 1.6 41.2 2.4 56.3 1.3 12.1-.8 14.2-1.2 19-3.8 7.9-4.3 10.9-9.1 12.1-19.6 1.2-10.3-.1-23.1-2.9-28.5-2.4-4.6-9-9.8-14.1-11.3-4.7-1.3-46.4-2.1-59.7-1.1M161 88c-13.2.9-19.3 3.3-25.4 10.1-6.8 7.5-7.4 10.9-8.1 43.4-.3 15.4-.2 37 .3 48 .7 17.5 1.1 20.7 3.1 25.2 2.6 5.9 9.1 12.4 14.8 14.8 10.5 4.4 58.5 4 69.1-.5 6.9-3 13.4-10.2 15.5-17.2 2.1-6.8 3.2-52.7 1.9-81.3-.7-17.5-1.1-20.7-3.1-25.2-2.6-5.9-9.1-12.4-14.8-14.8-6.8-2.9-31-4-53.3-2.5M35.5 167.9c-8.3.6-10.9 1.2-15.5 3.7-8 4.3-11 9.1-12.2 19.6-1.2 10.3.1 23.1 2.9 28.5 2.4 4.6 9 9.9 14.1 11.2 5.7 1.6 41.2 2.4 56.3 1.3 12.1-.8 14.2-1.2 19-3.8 7.9-4.3 10.9-9.1 12.1-19.6 1.2-10.3-.1-23.1-2.9-28.5-2.4-4.6-9-9.8-14.1-11.3-4.7-1.3-46.4-2.1-59.7-1.1"/></svg>`,
    createTable: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M78.9 8.1C37.8 9.4 29.6 11 20.2 19.5 10.8 27.9 9.6 34.3 8 85.9c-1.2 34.8-.1 91.9 2.1 110.6 1.7 15 7.8 24.9 18.4 30 7.1 3.3 16.3 4.2 57.6 5.5 34.4 1.1 89.6.1 109.8-2 21.5-2.3 31.9-12.4 34.1-33.2 2.1-20.1 3.1-75.6 2-109.9-1.6-50.9-2.6-57-11.5-66.7-8.3-9.3-15.3-10.6-63.9-12.2-33.1-1.1-41.3-1.1-77.7.1M99 50.2c7.5 3.8 8.1 6 7.8 28.3-.3 18.2-.4 19.1-2.7 22.4-3.9 5.4-6.9 6.1-26.4 6.1-15.9 0-17.6-.2-21.7-2.3-7.5-3.7-8.1-5.9-7.8-28.2.3-18.2.4-19.1 2.7-22.4 3.9-5.4 6.5-6 26.1-6.1 16.3 0 17.9.2 22 2.2m85 0c7.5 3.8 8.1 6 7.8 28.3-.3 18.2-.4 19.1-2.7 22.4-3.9 5.4-6.9 6.1-26.4 6.1-15.9 0-17.6-.2-21.7-2.3-7.5-3.7-8.1-5.9-7.8-28.2.3-18.2.4-19.1 2.7-22.4 3.9-5.4 6.5-6 26.1-6.1 16.3 0 17.9.2 22 2.2m-85 85c7.5 3.8 8.1 6 7.8 28.3-.3 18.2-.4 19.1-2.7 22.4-3.9 5.4-6.9 6.1-26.4 6.1-15.9 0-17.6-.2-21.7-2.3-7.5-3.7-8.1-5.9-7.8-28.2.3-18.2.4-19.1 2.7-22.4 3.9-5.4 6.5-6 26.1-6.1 16.3 0 17.9.2 22 2.2m85 0c7.5 3.8 8.1 6 7.8 28.3-.3 18.2-.4 19.1-2.7 22.4-3.9 5.4-6.9 6.1-26.4 6.1-15.9 0-17.6-.2-21.7-2.3-7.5-3.7-8.1-5.9-7.8-28.2.3-18.2.4-19.1 2.7-22.4 3.9-5.4 6.5-6 26.1-6.1 16.3 0 17.9.2 22 2.2"/></svg>`,
    createImage: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M107.7 3.1C85 4.8 60.5 14 44.4 26.8 19.9 46.2 5.8 74 3.2 108c-4.7 60.6 26 109 79 124.4 12 3.5 23 4.8 38.8 4.7 47.4-.2 85.4-22.3 104.1-60.6 8.8-18.1 12.1-34.2 12-57.5-.3-74-53.5-121.6-129.4-115.9m54.9 56.8c7.9 3.6 12.5 13.2 10.4 21.3-3.4 12.7-15.3 19-26.8 14.3-15.3-6.5-16.3-26.6-1.7-35.6 4-2.5 12.6-2.5 18.1 0M86 119.5c4 2 16.3 12.7 32.6 28l13.1 12.3 8.9-7.4c11.8-9.9 25.6-19.2 29.7-19.9 4.9-1 10.9 1 16.4 5.4 8.1 6.4 24.4 21.2 25 22.7.7 1.8-3.8 11.3-8.8 18.8-13.9 20.6-35.1 33.9-61.9 38.7-10.6 1.9-33.5 1.7-43.8-.5-11.5-2.3-23.4-6.8-32.6-12.2-9.1-5.3-21.3-16.5-26.9-24.8-4.3-6.3-11.5-21.1-11.9-24.4-.2-1.5 2.5-4.5 10.2-11.3 12.7-11.1 29-23.5 34.5-26.1 4.5-2.1 10.6-1.8 15.5.7"/></svg>`,
    createWeb: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M116.8 3c-10.7 3.2-20.7 17.2-28.3 39.5-3 9.1-7.5 29.1-6.7 30 .3.3 17.6.5 38.5.5h38l-.7-5.4c-.9-8.3-7.2-28.9-11.6-38.2-6.7-14.5-14.4-23.9-21-25.8-4.6-1.4-5.5-1.4-8.2-.6M83.5 8.2C58.3 17 36.7 33.3 22.2 54.7 18 60.9 13 70.3 13 72c0 .7 8.5.9 26.6.8l26.7-.3 2.3-11c4.5-21.4 11.6-40.8 18.5-50.7 3-4.1 2.3-4.6-3.6-2.6m70.6 4c8.3 14.1 14.4 32.4 19.5 58.5l.4 2.3h26.5c17.3 0 26.5-.4 26.5-1 0-1.4-5.4-10.9-10.9-19.4-9-13.9-27.4-29.8-44.1-38.1-5.2-2.6-18.4-7.5-20.2-7.5-.5 0 .6 2.4 2.3 5.2M6.6 88.7c-4.8 15.8-5.2 41-1 57.6l1.6 6.7h56.3V87H35.3c-26 0-28.2.1-28.7 1.7m72.9-.7c-1.3 2.1-2.2 32.3-1.5 46.5.5 8.2.9 15.8.9 16.8.1 1.6 2.5 1.7 40.8 1.5l40.8-.3.8-5c1-6.6 1.2-42.9.2-52.8l-.7-7.7h-40.4c-25.1 0-40.5.4-40.9 1m97 32v33h28.2c26 0 28.2-.1 28.7-1.8 4.8-15.7 5.2-40.9 1-57.5l-1.6-6.7h-56.3zM13 168c0 1.6 7.6 14.7 12.5 21.5 10.3 14.4 23.1 25.5 39.6 34.4 6.7 3.6 20.6 9.1 23.1 9.1.5 0-.3-1.9-1.7-4.3-8.4-13.4-14.5-31.7-20.1-59.5L66 167H39.5c-17.5 0-26.5.3-26.5 1m68.8-.4c-.3.3.3 4.4 1.3 9.2 6.1 27.7 16.8 50 27.9 57.7 14 9.7 30.1-5.3 40.9-38.5 3.3-10.1 7.1-27 6.4-28.3-.5-.8-75.7-1-76.5-.1m92.1-.4c0 .2-1.1 5.5-2.5 11.8-3.4 16.4-8 29.8-14.5 42.7-3.1 6.2-5.4 11.3-5 11.3.5 0 3.2-.9 6.2-1.9 24.7-8.7 45.2-24.4 59.7-45.8 4.2-6.2 9.2-15.6 9.2-17.3 0-.7-8.9-1-26.5-1-14.6 0-26.5.1-26.6.2"/></svg>`,
    createWords: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M95.8 16.4c-5.3 1.9-8 3.8-12.3 8.8-4.7 5.4-20.9 35.9-51.7 97.8-22.2 44.4-24.2 49-24.6 54.5s-.1 6.4 2.3 9.3c3.7 4.4 6.4 5.7 16.5 7.7 20.2 4.1 24.2 1.4 36.3-25.1l3.2-7.1 34 6.4c18.6 3.5 34 6.5 34.1 6.6.2.1.6 5.6.9 12.2.8 15.4 1.9 19.8 6.4 24.5 4 4.2 9.4 6.2 22 8 7.2 1.1 8.2 1 12.5-.9 5.6-2.4 8.5-7.8 8.6-15.6 0-9.8-10-114.2-14-145.9-3.3-25.8-8.6-32.2-31.6-38-18.9-4.7-35-5.9-42.6-3.2m26.3 48.2c.8 1 2.7 13.1 5 32.8 2 17.1 3.5 31.2 3.4 31.4-.2.2-44.8-7.9-45.3-8.3-.4-.4 27.9-53.8 29.6-55.8 1.9-2.1 5.5-2.2 7.3-.1m52.2-40.4c3.3 4.4 6.2 10.4 7.6 15.6 2.1 7.5 7.4 55.9 14.2 128.7 1.2 12.6 2.2 27.7 2.3 33.5.1 9.5-.2 11-2.6 15.9-1.5 3-2.5 5.8-2.2 6.3.3.4 6.9.8 14.8.8 13.2 0 14.6-.2 17.7-2.3 4.7-3.1 6.9-7.9 6.9-15.3 0-11.1-10.3-118.1-14.5-149.6-1.6-12.4-4.3-18.6-10.5-24.2-2.3-2-6.1-4.6-8.5-5.6-4.1-1.7-23.9-7-26.4-7-.7 0-.1 1.5 1.2 3.2"/><path fill="${ color }" d="M70.6 186.6c-2 4.1-4.5 8.8-5.7 10.2l-2.1 2.7 4.4.7c2.3.3 8.4.7 13.4.7 8.2.1 9.8-.2 14.5-2.7 3.9-2 6.2-4.1 8.3-7.5 1.6-2.6 2.7-4.9 2.4-5.2-.2-.3-6.5-1.6-13.9-3s-14.4-2.7-15.5-3c-1.9-.4-2.7.6-5.8 7.1"/></svg>`,
    createAnimation: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M113.5 8.9c-4.4 1.8-7.9 7.3-21.1 32.4-7.5 14.4-14 26.6-14.5 27.1-.4.5-13.8 3.5-29.6 6.6-15.9 3.2-30.3 6.5-32.1 7.4-7.1 3.7-10.5 16-6.4 23.3.9 1.7 10.7 13.1 21.7 25.3 16.7 18.4 20 22.6 19.8 24.8-.2 1.5-1.9 15.5-3.8 31-2.1 16.8-3.3 29.8-2.9 31.9.8 4.3 5.7 10.1 10.1 11.9 7.1 3 9.6 2.2 38.3-12.1l27-13.5 7.8 3.9 7.7 3.9v-23.2c0-32.2 1.9-41.8 10.1-50 6-5.9 11.4-8.1 20.9-8.1 7.5 0 8.7.3 18.5 4.9 5.8 2.6 11.2 4.9 12.1 5 2 .1 31.6-32.5 33.5-37 3.5-8.3 0-18.3-7.7-22-2.6-1.3-15.4-4.2-31.9-7.4-15.1-2.9-28-5.7-28.6-6.4-.6-.6-7.1-12.6-14.4-26.6s-14.4-26.8-15.9-28.4c-4.5-4.9-12.8-7-18.6-4.7"/><path fill="${ color }" d="M157.3 148.4c-4.6 3.8-6.1 9-7.4 24.3-1.6 20.2.3 46.8 3.7 52.1.8 1.3 2.9 3.2 4.7 4.3 6.5 4.1 17 .8 43.2-13.4C226.2 202.3 232 197 232 188c0-8.4-5.2-12.9-31.7-27.4-17.9-9.7-27.9-13.9-34.3-14.4-4.9-.4-6-.1-8.7 2.2"/></svg>`;
    },
    errorCheck: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M99.2 6.1c-13.5 6.7-63.1 89-86.1 143.1C2.5 174.1.8 181.5 3.8 188.1 9.1 200 14.6 201.5 62 204c19.2 1 64 1.4 64 .6 0-.2-.7-3.2-1.6-6.5-3-12 1.6-22 14.8-31.6 7-5.2 12.2-6.9 19.8-6.3 6.7.5 11.5 2.7 17.5 8 2.5 2.2 4.7 3.9 4.9 3.7s4.1-5.6 8.9-12c4.7-6.4 9.5-12.4 10.8-13.2l2.2-1.6-3.7-8.3c-18.2-40.3-59.2-109.1-74.8-125.7-6.6-7-17.3-9.1-25.6-5m21 49.1c4.6 1.7 6.8 6.5 6.8 14.5 0 7.3-2.6 35.9-3.7 40.3-1.6 6.6-5.7 9-15.4 9-5 0-6.3-.4-9-2.8-3.6-3.2-4.2-5.8-6.4-27.5-2.4-24.3-1.9-29.1 3.8-32.7 4.4-2.7 17.6-3.2 23.9-.8m-4.9 88.2c4.2 1.7 8.3 6.6 9.8 11.5 3.9 12.9-9.9 24.8-22.3 19.3-13.4-5.9-13.6-24.3-.4-30.3 4.9-2.2 8.5-2.4 12.9-.5"/><path fill="${ color }" d="M211.7 157c-2.9 2.3-16.4 20.3-23.5 31.4l-4.8 7.5-9-9c-9.9-10.1-12.7-11.9-17.9-11.9-4.8 0-8.2 1.9-13.2 7.3-9 9.7-8.1 12.1 12 32.5 19.2 19.4 22.4 21.6 30.4 21 5.4-.5 6-.8 10.9-6.1 5.7-6.1 32.4-41.4 37.3-49.3 1.8-2.7 3.4-6.6 3.7-8.6.6-3.2.2-4.1-3.6-8.1-7.4-8.1-16.9-10.9-22.3-6.7"/></svg>`;
    },
    exportEpub2: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M114 2.9c-4.4 1.4-8.4 3.8-11 6.5-1.4 1.5-8.6 14.2-16 28.3L73.5 63.3l-27 5.3c-14.8 2.9-28.9 6.2-31.2 7.3C5.1 80.8-.5 97.1 4.2 108c.8 2 10.4 13.4 21.2 25.4 18.4 20.3 19.7 22.1 19.2 25-.2 1.7-1.9 15.1-3.7 29.8-2.8 23.4-3 27.2-1.9 31.2 3 10.7 12.6 18 23.8 18 6 0 7.2-.5 32-12.8l25.8-12.8 24.1 12.1c13.3 6.6 26.2 12.5 28.7 13.2 12.6 3.1 26.3-7.2 28.2-21.2.3-2.6-.9-16.1-3-32.7L195 155l18.2-20.1c10.1-11.1 19.3-21.7 20.5-23.7 7.5-12.2 3.4-28.7-8.7-34.9-2.9-1.5-13.8-4.1-31.4-7.5l-26.9-5.3L153.9 39c-7-13.5-14.2-26.2-16-28.4-5.2-6.2-16.9-10-23.9-7.7m24.6 84.5c9.1 4.2 15.4 14.2 15.4 24.4 0 7.4-2 12.3-7.5 17.8-4.3 4.3-7.2 6.1-20.5 11.8-8.5 3.7-16.3 7.5-17.3 8.5-.9.9-2.1 3.1-2.6 4.9l-1 3.2h43.1l2.9 2.9c3.8 3.9 4 8.8.3 12.2-2.6 2.4-2.6 2.4-29.2 2.7-28.5.3-30.9 0-33.3-4.5-1.5-2.9-1.9-15.5-.6-21.4 1-5 6-12.2 10.5-15.1 2-1.4 10.2-5.3 18.2-8.7 15.3-6.6 19-9.4 19-14.1 0-7-3.4-9-15.7-9-9.9 0-12.2 1-14.3 6-2.5 6-10 7.7-14.4 3.4-4.9-5-2.8-13.4 5.1-20.4 6.4-5.6 10.8-6.8 24.8-6.9 10.6-.1 12.6.2 17.1 2.3"/></svg>`;
    },
    exportEpub3: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M114 2.9c-4.4 1.4-8.4 3.8-11 6.5-1.4 1.5-8.6 14.2-16 28.3L73.5 63.3l-27 5.3c-14.8 2.9-28.9 6.2-31.2 7.3C5.1 80.8-.5 97.1 4.2 108c.8 2 10.4 13.4 21.2 25.4 18.4 20.3 19.7 22.1 19.2 25-.2 1.7-1.9 15.1-3.7 29.8-2.8 23.4-3 27.2-1.9 31.2 3 10.7 12.6 18 23.8 18 6 0 7.2-.5 32-12.8l25.8-12.8 24.1 12.1c13.3 6.6 26.2 12.5 28.7 13.2 12.6 3.1 26.3-7.2 28.2-21.2.3-2.6-.9-16.1-3-32.7L195 155l18.2-20.1c10.1-11.1 19.3-21.7 20.5-23.7 7.5-12.2 3.4-28.7-8.7-34.9-2.9-1.5-13.8-4.1-31.4-7.5l-26.9-5.3L153.9 39c-7-13.5-14.2-26.2-16-28.4-5.2-6.2-16.9-10-23.9-7.7M133.1 86c5.2 1.4 12.8 8.5 15.5 14.5 3.2 6.8 3.2 14.6 0 20.9l-2.4 4.8 2.7 3.9c3.8 5.2 5.4 11.5 4.9 19.6-.5 7.9-2.5 12.7-7.5 17.7-6.1 6.1-11.4 8-23.2 8.4-17.2.7-25.3-2.4-31.8-12.2-4.3-6.3-4.5-11.6-.7-15.1 3.7-3.4 8.5-3.3 11.5.2 1.3 1.4 3.9 4.2 5.6 6l3.3 3.5 10.1-.4c9.6-.3 10.2-.4 12.5-3.1 1.8-2.2 2.4-4 2.4-7.8 0-7.9-3.3-10.1-16.9-11.1-6.8-.6-9.9-9.5-4.9-14.4 2-2 3.9-2.7 8.7-3.1 5-.5 6.5-1.1 8.1-3.1 2.8-3.5 2.6-7.6-.6-10.1-2.2-1.7-4.1-2.1-10.5-2.1-7.4 0-7.8.1-10.1 3-5.7 7.5-6.4 8.1-10 8.7-3 .4-4.1.1-6.2-2-4.8-4.8-4.4-9.5 1.6-17.8 2-2.7 4.9-5 9.1-7 5.5-2.6 7.3-2.9 15.7-2.9 5.2 0 11.1.5 13.1 1"/></svg>`;
    },
    createLayer: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M113.5 13.6c-28.4 6.9-60.8 20.5-88.4 37C13.1 57.9 9.7 61.4 8.5 68c-.9 4.8 1.8 11.2 5.8 14.3 10.3 7.7 42.3 24.3 61.7 32 32.4 12.9 44.9 14.6 63.8 8.8 32.7-10 83.5-35.3 89-44.4 4.6-7.3 3.2-16.2-3.1-21-9.9-7.4-43-24.6-61.8-32-23-9.1-43-13.9-50.4-12.1"/><path fill="${ color }" d="M16.3 106.1c-9.5 6-10.5 19.8-2 26.2 10.3 7.7 42.3 24.3 61.7 32 32.4 12.9 44.9 14.6 63.8 8.8 32.7-10 83.5-35.3 89-44.4 4.9-7.9 3.1-16.7-4.6-22.1l-4.1-2.8-19.8 9.9c-22 11.1-39.9 18.4-58.5 23.9-20.2 6-30.1 5.3-57.2-4.1-15.2-5.3-37.4-15.1-51.3-22.7-6.9-3.7-12.8-6.8-13.2-6.8-.3 0-2 1-3.8 2.1"/><path fill="${ color }" d="M16.3 156.1c-9.5 6-10.5 19.8-2 26.2 10.3 7.7 42.3 24.3 61.7 32 32.4 12.9 44.9 14.6 63.8 8.8 32.7-10 83.5-35.3 89-44.4 4.9-7.9 3.1-16.7-4.6-22.1l-4.1-2.8-19.8 9.9c-22 11.1-39.9 18.4-58.5 23.9-20.2 6-30.1 5.3-57.2-4.1-15.2-5.3-37.4-15.1-51.3-22.7-6.9-3.7-12.8-6.8-13.2-6.8-.3 0-2 1-3.8 2.1"/></svg>`;
    },
    printPdf: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M101 8c-24.1 1.4-31.3 3.4-38.3 10.4-4.4 4.4-6.8 9.7-7.4 16.5l-.5 5.6H185v-3.1c0-11.4-8.3-22.8-19-26.2-8.7-2.8-43.4-4.5-65-3.2M64 53.1c-26.5.6-30.1.9-35 2.8-10.6 4-16.9 11.5-18.9 22.6C8 90 6.9 121.7 7.8 142.7c.9 18.3 1.2 20.6 3.5 25.6 5.1 11.2 15.5 17.7 28.1 17.7h6.4l-.2-20.8c-.1-20.5-.1-20.9 2.3-24.4 1.4-1.9 3.4-4.1 4.5-4.8 1.6-1 16.2-1.3 67.2-1.3 73.8 0 69.4-.5 73.6 8.2 2 4.2 2.1 5.3 1.4 23.7L194 186h6.4c3.5 0 8.3-.7 10.6-1.5 8.4-2.9 16.1-10.5 18.9-18.5 2.1-5.9 3.3-42.8 2.3-66.9-.9-20.2-1.1-22.3-3.5-27.4-3.3-7.2-9.4-13.1-16.5-15.7-5.2-2-8.6-2.3-40.7-3-39.4-1-64.6-1-107.5.1M185 95c1.1 1.1 2 3.3 2 5 0 4.8-3 7-9.5 7s-9.5-2.2-9.5-7 3-7 9.5-7c4.2 0 6 .5 7.5 2"/><path fill="${ color }" d="M60.1 164c0 8 .4 22.8.8 33 .8 20.9 2 25.1 8.4 30.7 4.6 4 8.1 4.9 23.2 6.2 22.8 2 56.8 1 69.9-2 7.1-1.7 14-8.6 15.4-15.4.6-2.8 1.4-18.9 1.8-36l.7-31H60z"/></svg>`;
    },
    viewPdf: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M65 3.1C31.2 4.5 23.4 6.3 14.3 15.2 5.8 23.5 4.6 29.7 2.9 78c-1.8 48.8.2 120.6 3.7 132.9 4 14 13.7 21.9 29.5 24.1 9.6 1.3 51.6 3 73.8 3h17.3l-7.9-7.8c-9.3-9-13.5-14.8-18-25.2-2.6-6-3.3-8.9-3.3-14.1 0-21.6 20.5-46.9 46.9-57.7 17.4-7.1 38.5-7 61.4.5 1.6.5 1.7-.7 1.7-15.4 0-8.8-.3-19.4-.6-23.5l-.7-7.5-17.1-.6c-34.8-1.3-43.6-3.2-52.6-11.3-5.5-5-8.7-10.1-10.4-16.7-1.3-4.8-3.3-31.1-3.9-49.2l-.2-7-19-.1c-10.4-.1-27.8.2-38.5.7m31.7 50.1c4.7 4.8 2.8 13.5-3.5 15.9-1.6.6-12.3.9-27.5.7l-24.9-.3-3-3.4c-2.5-2.8-2.9-3.9-2.4-7 .3-2.3 1.7-4.6 3.6-6.4l3.1-2.8 25.9.3 26 .3zm30 45c3.8 3.9 3.8 9.7 0 13.6l-2.7 2.7H40.8l-3-3.4c-2.5-2.8-2.9-4-2.5-6.9.7-3.7 3-6.9 6.2-8.3 1.1-.4 20.1-.7 42.2-.6l40.3.2zm-43.4 43.1c4.5 1.9 6.2 4.4 6.1 8.9-.1 2.9-.9 4.7-2.8 6.7l-2.6 2.6H40.8l-3-3.4c-2.5-2.8-2.9-4-2.5-6.9.7-3.8 3-7 6.2-8.3 3.5-1.4 38.2-1.1 41.8.4"/><path fill="${ color }" d="M137.7 14.2c1.2 27.8 2.4 39.3 4.9 44.4 3.4 7.1 8 10.1 17.5 11.4 11 1.5 41.9 2.5 41.9 1.4 0-1.4-7.1-13.3-12-19.9-6.4-8.9-21.4-24-30.4-30.7C153 15.9 139 7 137.8 7c-.2 0-.2 3.3-.1 7.2m23.7 127.3c-20.2 4.4-37.5 17.4-45.5 34.5-4.5 9.3-4.3 14 1.1 24.6 15.7 30.9 54.4 43.1 87.3 27.5 10.1-4.7 17.2-10.3 23.3-18.4 6.4-8.4 9.6-16 9.7-22.3 0-10.9-13.5-29.8-26.9-37.6-15.3-8.9-32.7-11.9-49-8.3m22.1 28.4c11.4 5.1 14.8 19.3 7.2 29.3-4.2 5.4-8.9 7.8-15.2 7.8-15.9-.1-24.8-14.8-17.5-29 4.6-9 15.7-12.6 25.5-8.1"/></svg>`;
    },
    exportGoogle: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M104.2 6.6C71 12.2 43.4 32.4 28.1 62.5c-8 15.8-11.8 31.1-12.8 51-1.2 26.3 4.7 50.4 17.5 72 6.2 10.5 23.8 28.4 34 34.5 16 9.5 31.3 13.8 51.7 14.7 30.4 1.2 57.1-8.4 76.5-27.7 20.8-20.7 31-49.1 29.8-82.7-.3-9.6-.7-11.4-3.2-16.1-1.6-2.8-4.5-6.4-6.4-7.8-6.9-5.3-10-5.7-43.7-5.8-40.6 0-47.8 1.3-53.3 9.7-2.6 3.8-2.7 4.7-2.7 16.1 0 10.6.3 12.6 2.2 16.3 4.7 8.7 9.8 10.2 34.1 10.3h17.4l-.7 3.2c-2.3 10.3-11.8 22.9-21.2 28-8.7 4.8-16.8 6.2-28.4 5-16.4-1.7-26.8-7.7-35.4-20.2-18.5-26.7-14.2-75.1 8.3-95.1C102 58.8 115 55.2 131 57c10.3 1.2 17.7 3.7 27 9 9.5 5.5 13.9 6.5 20.5 4.5 6.3-1.8 9.7-5.4 14.5-15.1 6.6-13.4 6.3-22.9-1-30.5-6.9-7.3-29.9-16.4-47.4-18.8-10.4-1.5-30.2-1.2-40.4.5"/></svg>`;
    },
    innerDrive: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M86.9 8.1C54.6 9.3 47.3 11 38.7 18.9 31.3 25.7 30 30 20.2 80c-10.4 52.6-10.5 53-9.6 53 .3 0 1.8-.9 3.3-1.9 10.3-7.4 19.8-8.1 106.1-8 87.8 0 94.3.5 106.1 8.4 2.5 1.6 3.9 2.1 3.9 1.3 0-.7-4.5-23.7-10-51-6.3-31.7-10.7-51.2-12-53.8-3.1-6-8.7-11.8-14.2-14.6-6.4-3.2-14.5-4.2-44.1-5.4-27.7-1.1-33.9-1.1-62.8.1M63 138c-27.2.7-30 .9-35.5 3-8.3 3.1-15.8 10.8-17.9 18.2-3.5 12.8-2.7 45.2 1.3 54.4 3.1 6.9 9.4 13 16.1 15.5 5.1 1.9 8.7 2.2 48.9 3.1 28.5.6 58.4.6 87 0 41.3-1 43.9-1.1 49.6-3.2 8.3-3.1 15.8-10.8 17.9-18.2 3.5-12.8 2.7-45.2-1.3-54.4-3.1-6.9-9.4-13-16.1-15.5-5-1.9-8.7-2.2-41-2.9-39.8-1-65.9-1-109 0m132.4 38.1c6.1 5.3 5.8 13-.6 18.4-8.9 7.5-23.2-2.8-18.8-13.5 3.4-8.2 12.9-10.6 19.4-4.9m-41.4.7c6.5 3.2 7.4 10.8 1.9 15.8-2 1.8-4.7 1.9-55.4 1.9-52.3 0-53.4 0-56.1-2.1-4.1-3-5-6.6-2.7-11.1 1-2.1 2.9-4.3 4.3-5 1.9-1 14.9-1.3 53.5-1.3 46.6 0 51.3.2 54.5 1.8"/></svg>`;
    },
    outerDocuments: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M95.5 2.7C73.7 3.2 49.1 5.1 44 6.6c-6.7 2-11.6 5.1-15.9 9.9-7.7 8.8-8.6 14.8-10.1 67.2-1.1 36.8-.1 96.6 2 117 2.2 20.8 12.2 31.9 31.2 34.3 16.5 2.1 67.6 3.1 98.7 2 40.3-1.4 46.8-2.3 55.1-7.5 9-5.6 13.6-14.2 15-27.9 1.5-14.4 3.3-86.2 2.5-101l-.7-13.3-17.9-.6c-34-1.3-42.9-3.2-51.9-11.3-5.7-5.1-8.7-10.2-10.5-17.2-1.6-6.7-3.5-30.7-3.5-45 0-8.2-.3-10.1-1.6-10.6-1.5-.6-14.6-.5-40.9.1M125 100c2.6 2.6 2.6 7.4 0 10-1.9 1.9-3.3 2-32.5 2s-30.6-.1-32.5-2c-1.1-1.1-2-3.3-2-5s.9-3.9 2-5c1.9-1.9 3.3-2 32.5-2s30.6.1 32.5 2m55 40c1.1 1.1 2 3.3 2 5s-.9 3.9-2 5c-2 2-3.3 2-60 2s-58 0-60-2c-1.1-1.1-2-3.3-2-5s.9-3.9 2-5c2-2 3.3-2 60-2s58 0 60 2m0 40c1.1 1.1 2 3.3 2 5s-.9 3.9-2 5c-2 2-3.3 2-60 2s-58 0-60-2c-1.1-1.1-2-3.3-2-5s.9-3.9 2-5c2-2 3.3-2 60-2s58 0 60 2"/><path fill="${ color }" d="M152.9 7.7c-.3 3.8.3 20.3 1.2 31.8 1.7 22.6 6 28.7 21.3 30.6 7.9 1 40.8 2.7 41.5 2.2.8-.6-2.1-5.9-8.7-15.8-8.4-12.8-27.2-31.8-39.2-39.6-12.2-8-16-10.2-16.1-9.2"/></svg>`;
    },
    outerFonts: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M26.1 8c-3.9.9-7.7 3.5-10.4 7.2-2.4 3.2-4 21.5-3.5 40.5.3 11.4.6 13.5 2.4 16 3.7 5 7.8 6.5 17.4 6 13.7-.6 16.8-3.2 19-16l1.2-6.7H94v137.9l-5.7 1.1c-17.7 3.5-20.6 6.4-20.5 20.7 0 6.6.4 8.9 2.1 11.6 3.8 6.1 4.2 6.2 50.6 6.2 38.3 0 42.3-.2 45.2-1.8 4.8-2.6 6.6-6.8 6.6-15.7-.1-13.8-3.3-17.5-17.9-20.5l-8.4-1.8V55h41.9l.6 3.7c1.3 8.1 4 14.6 6.8 16.7 2.5 1.8 4.3 2.1 13.2 2.1 11.7 0 14.4-1.2 17.8-7.6 1.7-3.1 1.8-5.3 1.3-24.9-.6-22.5-1.3-27-4.7-31.4-5.1-6.5 1-6.1-100.9-6.3-50.9 0-94 .2-95.9.7"/></svg>`;
    },
    outerVideo: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M111.2 2.9c-5.5.5-6.7 1-9.2 3.8-3.7 4.1-4.6 8.9-2.7 13.6 2.6 6.2 5.2 7.1 21.7 7.8 17.6.7 25.2 2.5 38.6 8.9 32.7 15.8 52.3 47.2 52.4 83.8 0 35.3-20.2 67.2-52.2 82.2-15.1 7-22 8.5-40.3 8.5-17.8-.1-22.8-1.1-36.4-7-9.8-4.3-15.6-4.6-19.5-1-7.8 7.3-5.7 16.9 5 21.9 17.6 8.3 32.9 11.8 51.9 11.7 32.4-.1 60.1-11.5 82.5-34s34.4-51.7 34.2-83.7c-.3-45-24.3-83.8-64.7-104.2-18.4-9.3-42.1-14-61.3-12.3M65.3 16C51.1 23.1 36 35.4 33.9 41.7c-2.6 8 2.3 15.3 10.8 16 5.4.5 6.3 0 16.7-8.8 3.7-3.1 10.2-7.5 14.6-9.9 8.6-4.6 11-7.2 11.7-13 .9-6.7-3.4-12.2-10.7-13.5-2.9-.5-5 .1-11.7 3.5"/><path fill="${ color }" d="M110.4 43.1c-29.3 3.4-54.7 24.5-63.9 53.2-6.8 21.2-4.4 44.4 6.6 63 5.8 9.8 18.4 22.3 27.9 27.6 25 13.8 54.8 13.9 78.3 0 9.8-5.8 22.3-18.4 27.6-27.9 13.8-25 13.9-54.8 0-78.3-2.5-4.3-7.7-10.6-12.8-15.7-7-7-10.4-9.4-18.1-13.3-15-7.5-30.3-10.4-45.6-8.6m4.9 45.2c13.4 5.7 34.7 17.1 39.7 21.5 7.4 6.3 7.4 14.1-.1 20.5-4.4 3.8-30.9 17.7-44.1 23.1-11.1 4.6-14.9 4.7-19.3.3-4-4-5.3-9.4-6.1-26.5-.7-14.3.9-32.9 3.2-37.4 2.3-4.3 7.1-7 11.9-6.5 2.3.2 8.9 2.5 14.8 5M17.1 65.5c-7.6 6.4-17.4 46-13.7 54.9 2.1 5.1 6 7.6 11.8 7.6 4.3 0 5.5-.5 8.3-3.3 2.6-2.6 3.5-4.4 3.9-8.3 1.6-13.1 2.9-19.6 5.8-27.4 3.5-9.7 4.5-16.8 2.8-20-3.2-6-13.5-7.9-18.9-3.5M11 140.8c-3.3 3.3-4 4.6-4 7.9 0 11.6 13.2 37 26.3 50.4 9.4 9.8 21.4 6.4 22.5-6.4.4-5.2.3-5.4-5.5-12.5-7.8-9.6-11.8-16.3-16.7-28.4-4.6-11.4-6.9-13.7-14-14.5-4.3-.5-4.8-.3-8.6 3.5"/></svg>`;
    },
    showTemplates: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M60.5 3C48.9 3.4 37 4.1 34 4.5 19.4 6.5 9 15.3 5.5 28.6 3.1 37.9 1.7 88.8 3 124c1.1 32.3 1.4 35.4 4.2 42 4.1 9.6 11.4 15.9 21.4 18.5 9.3 2.4 60.2 3.8 95.4 2.5 32.3-1.1 35.4-1.4 42-4.2 9.6-4.1 15.9-11.4 18.5-21.4 2.4-9.3 3.8-60.2 2.5-95.4-.5-16.2-1.3-31.3-1.7-33.5-1.5-9.2-6.6-17.5-13.7-22.5-7.3-4.9-13.3-5.9-44-7-30.3-1-35.2-1-67.1 0m.3 24.6c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7m50 0c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7m50 0c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7M38.3 76.4c1.8.8 8.4 6.6 14.7 13 10 10.2 11.4 11.9 11.4 14.9 0 6.5-5.7 11.6-11.4 10.2-3.6-.9-26.8-24.1-27.5-27.7-.8-3.5 2-8.7 5.6-10.5 3-1.6 3.3-1.6 7.2.1m50 0c1.8.8 8.4 6.6 14.7 13 10 10.2 11.4 11.9 11.4 14.9 0 6.5-5.7 11.6-11.4 10.2-3.6-.9-26.8-24.1-27.5-27.7-.8-3.5 2-8.7 5.6-10.5 3-1.6 3.3-1.6 7.2.1m50 0c1.8.8 8.4 6.6 14.7 13 10 10.2 11.4 11.9 11.4 14.9 0 6.5-5.7 11.6-11.4 10.2-3.6-.9-26.8-24.1-27.5-27.7-.8-3.5 2-8.7 5.6-10.5 3-1.6 3.3-1.6 7.2.1m-77.5 51.2c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7m50 0c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7m50 0c3.2 2.1 4.5 6 3.2 9.8-1.5 4.6-23.6 26.4-27.5 27.1-6.1 1.1-12.5-5.5-11-11.4.7-2.8 22.7-25.7 26-27.2 2.4-1 6.2-.3 9.3 1.7"/><path fill="${ color }" d="M202 93.2c0 43-1.1 64.3-3.6 72.8-3.6 12.3-12.9 23.7-23.8 29.2-10.8 5.5-15.4 5.9-70.4 6.5l-50.3.6.7 4.6c2.1 13.9 11.1 24.2 24 27.6 9.3 2.4 60.2 3.8 95.4 2.5 32.3-1.1 35.4-1.4 42-4.2 9.6-4.1 15.9-11.4 18.5-21.4 2.4-9.3 3.8-60.2 2.5-95.4-1.1-32.3-1.4-35.4-4.2-42-4.1-9.6-11.4-15.9-21.4-18.5-10.4-2.7-9.4-6.9-9.4 37.7"/></svg>`;
    },
    viewReports: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M78.9 8.1C37.8 9.4 29.6 11 20.2 19.5 10.8 27.9 9.6 34.3 8 85.9c-1.2 34.8-.1 91.9 2.1 110.6 1.7 15 7.8 24.9 18.4 30 7.1 3.3 16.3 4.2 57.6 5.5 34.4 1.1 89.6.1 109.8-2 21.5-2.3 31.9-12.4 34.1-33.2 2.1-20.1 3.1-75.6 2-109.9-1.6-50.9-2.6-57-11.5-66.7-8.3-9.3-15.3-10.6-63.9-12.2-33.1-1.1-41.3-1.1-77.7.1M124 41.8c4.7 2.3 6.5 6.2 5 10.6-2.4 7.4-.8 7.1-43.5 7.1-37.2 0-38.4-.1-41.1-2.1-4.1-3-5-6.6-2.7-11.1 1-2.1 2.9-4.3 4.3-5 1.9-.9 11.8-1.3 38.5-1.3 32.3 0 36.4.2 39.5 1.8m-30 40c4.7 2.3 6.5 6.2 5 10.6-2.3 7-2.5 7.1-28.5 7.1-22 0-23.5-.1-26.1-2.1-4.1-3-5-6.6-2.7-11.1C44.6 80.4 46 80 69.5 80c18 0 21.5.3 24.5 1.8m94.5 27.2c12.8 6.2 12 11.9-5.2 37-15.1 21.9-26.3 34.1-32.9 35.9-9.4 2.6-14.2.8-31.3-12.2-11.7-8.9-14.7-10.6-15.5-9.5-21.9 29-29 38-30.8 38.9-1.2.7-3.9 1.2-6 1.2-4.6 0-12.4-5-18.8-11.9-3.4-3.7-4-5-4-8.6 0-5.3 1.5-7.7 12-19.8 28.4-32.6 34.8-37.7 45.9-36.7 7.8.7 10.5 2.2 25.6 14.9 7.2 5.9 13.7 10.7 14.5 10.6.8-.2 9-9.1 18.2-19.8 14.7-17.2 19.6-21.8 23.2-22 .5 0 2.8.9 5.1 2"/></svg>`;
    },
    codeView: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M58.5 12c-25.2 1.1-28.9 1.5-35.2 4.5-9.5 4.3-16.2 13.2-18.2 24.1-.5 2.7-1.5 16.2-2.1 30-1.7 36.3 0 81.9 3.5 92.5 2.1 6.3 9.3 14.1 15.8 17.3 6.9 3.4 15.3 4.4 45.6 5.2 22.3.6 25.1.9 24.7 2.3-.2.9-.7 4.2-1.1 7.3-.9 7.9-2.3 8.8-14.5 8.8-11.6 0-15.1 1.7-18.1 8.6-2.5 5.5-1.9 9.1 2.2 13l3 2.9 55.4.3 55.3.2 3.1-2.5c1.7-1.5 3.6-4.4 4.2-6.5 1-3.2.9-4.4-.7-7.6-3.3-6.6-6-7.9-18.4-8.2-13-.4-13.4-.7-14.7-11l-.9-7.2h12c6.7 0 20.5-.5 30.8-1 22.7-1.2 27.6-2.6 35.4-10.4 9.1-9.1 10.6-16.7 11.9-60.1.7-22-.8-63.6-2.6-73.9-1.4-7.8-4-12.8-9.5-18.2-6-5.8-13.2-8.3-26.9-9.5-15.3-1.3-115.7-1.9-140-.9m133.2 20.9c10.5.7 12.8 1.2 15.7 3.2 6 4.1 7.5 8.1 8.7 23 1.3 15.8.6 85.3-1 91.3-1.4 5.5-4 8.7-9.2 11.4-4 2-6.9 2.3-24.5 3.2-25.4 1.2-96.8 1.2-123.1 0-13.3-.6-21.4-1.4-23.6-2.4-4.6-1.9-8.4-7.1-9.9-13.7-1.8-7.7-1.8-93 0-100.9 1.9-8.3 7.2-13.2 15.8-14.6 13.7-2.1 120-2.5 151.1-.5"/><path fill="${ color }" d="M124.7 55.1c-.9.5-2.4 2.3-3.1 3.8-1.9 3.6-21.6 72.3-21.6 75.2 0 3.8 3.2 7.9 7.3 9.1 3.3 1 4.4.9 7.2-.6 1.9-1 3.8-3 4.4-4.5 2.3-5.8 21.1-73.2 21.1-75.6 0-4.1-5-8.5-9.7-8.5-2.1 0-4.6.5-5.6 1.1m-55.2 5.1c-4.8 2.7-18.4 13.7-23.9 19.2-10.6 10.9-13 19.9-7.7 29.1 5.1 9 28.7 28.8 35.8 30.1 6.3 1.2 12.1-5.4 10.9-12.2-.6-2.8-2.3-4.6-10.4-10.8-11.7-8.9-18.7-15.9-17.9-17.9.6-1.6 10.7-10.4 20.5-18 8.9-6.8 10.6-12.5 5.3-17.8-3.2-3.2-8.7-3.9-12.6-1.7m89 1.2c-5 5-4.5 10.9 1.3 15.5 2 1.7 7.5 6.1 12.1 9.8s9.3 8 10.5 9.6l2 2.7-4.4 4.6c-2.5 2.5-8.6 7.6-13.6 11.4-11.9 9-14 13.7-8.8 19.9 3.1 3.8 8 4.9 12.1 2.8 5.3-2.8 20.7-15.3 26.2-21.3 14-15.3 12-26-7.9-42.8-17.7-14.9-24.1-17.6-29.5-12.2"/></svg>`;
    },
    multiView: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M162 2.9c-13.1.9-20.2 4.8-24.7 13.5-2.5 4.7-3.6 30-3 68.6.5 30.9.7 34 2.7 39.2 2.4 6.5 7.7 11.8 13.6 13.9 3 1.1 11.3 1.4 35.4 1.4 30.8 0 31.6-.1 36.5-2.3 6.1-2.8 9.1-5.5 11.8-10.7 1.9-3.6 2.2-6.6 3-29.7.6-15.7.6-35.4 0-50.5-1-27.2-1.7-30.5-7.9-36.7-6-6-8.9-6.5-34.5-7-12.9-.2-27.7-.1-32.9.3m6.6 24.9c2.3 7.9 3 8.2 17.4 8.2s15.6-.5 17.5-8.3c1.1-4.1 1.2-4.2 5.7-4.5 8.2-.5 7.8-3.1 7.8 47.7 0 37-.2 45.1-1.4 46.7-1.4 1.8-2.9 1.9-29.5 1.9-24.5 0-28.2-.2-29.7-1.6-1.4-1.5-1.6-6.4-1.6-46.2 0-31.6.4-45.1 1.2-46.7 1-1.8 1.9-2.1 6.2-1.8 5.1.3 5.1.3 6.4 4.6"/><path fill="${ color }" d="M178 95.7c-5.1 1.9-6.8 8.5-3 12.3 1.7 1.7 3.3 2 11 2s9.3-.3 11-2c2.8-2.8 2.6-7.5-.5-10.5-2.1-2.2-3.2-2.5-9.7-2.4-4 0-8 .3-8.8.6M84.2 58.1c-20.8.9-39.6 3.1-47 5.5-12 3.9-16.6 11.6-18.3 30.4-1.3 13.3-1.7 92-.5 95.6.6 1.9.2 2.3-3.1 2.9-10.1 1.9-12.9 6.1-11.9 17.9 1.1 13 5.7 20.2 14.4 22.5C36 237.7 147 239 195.5 235c15.4-1.3 21.1-2.9 25.3-7.3 3.9-4.1 5-6.9 5.8-16 1.1-12.4-2.1-17.9-11.2-19.3-3.5-.5-4.4-1-4-2.3.3-.9.6-9.2.8-18.5l.3-17-11 .3c-6 .1-11.1.3-11.2.4 0 .1-.4 7.4-.8 16.2-.3 8.8-.8 17-1.1 18.2-.4 2.3-.6 2.3-18.2 2.3-20.2 0-24 .7-27.6 5.3-5.8 7.4-3.3 6.8-28.3 6.5-22.3-.3-22.6-.3-24.2-2.6-.9-1.3-2.8-3.8-4.3-5.5l-2.6-3.2-20.9-.5-20.8-.5-.6-11.5c-1-18.2-.9-51 .1-69.8 1.3-23.7 2.3-25.2 16.5-27.1 10.4-1.4 38.2-3.1 51.2-3.1h10.1l.7-8.3c.4-4.5.5-9.6.3-11.2l-.3-3-8.5-.1c-4.7-.1-16.7.2-26.8.7"/></svg>`;
    },
    outerImage: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M83.4 3.1c-38 1.4-46.3 3.1-54.2 11.2-8.6 8.7-9.6 15.1-11.3 70.6-.7 24.4-.7 44.7 0 69.6 1.6 53.8 2.8 61.4 10.3 70 5.6 6.4 11.8 9.2 22.5 10.5 19.1 2.1 67.8 3.2 98.7 2.1 46.5-1.7 51.9-2.7 60.9-11 8.9-8.3 10-14.9 11.8-71 1.6-52.3-.8-118.3-4.7-130.3-2-6-8.4-13.2-14.5-16.3-6.2-3.2-15.4-4.2-49.4-5.5-29.6-1.1-38.6-1.1-70.1.1m91.5 38.2c9.3 6.2 12.7 12.8 11.8 23.2-1.1 14.2-12 23.4-26.2 22.2-14.2-1.1-23.4-12-22.3-26.1.8-9.3 5.9-16.8 14.3-20.8 5.9-2.8 17-2.1 22.4 1.5m-92.2 72.2c5.5 1.6 18.6 12.2 37.1 30 5.5 5.2 10.3 9.5 10.7 9.5s4.3-2.9 8.8-6.6c4.5-3.6 12-9.1 16.6-12.2 8-5.5 8.5-5.7 15-5.7 8.3 0 11.7 1.9 25.6 14.3l10 8.8-.3 16c-.4 23.6-1.9 39.1-4.2 43.9-4.2 8.8-8.7 9.4-69.2 10.2-44.3.5-76-.5-85.4-2.9-6.1-1.5-10.2-6.1-11.4-12.8-1.2-7.1-3-39-3-54.1v-11.8l9.8-7.8c18.8-15.2 26.8-20.1 32.8-20.3 1.1 0 4.3.7 7.1 1.5"/></svg>`;
    },
    pageView: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M75.2 3c-11.2.4-22.9 1.1-26 1.5-15.9 2-27 11-30.7 25-2.5 9.8-3.7 52.4-3.3 123.6l.3 67.6 3 4.8c2.1 3.3 4.7 5.7 8.5 7.9l5.5 3.1 22 .7c27.5.8 96 .8 133.1-.1 25.8-.5 28.4-.8 30.3-2.5 2.4-2.2 2.8-7.3.8-10-.7-1-2.9-2.1-4.7-2.5l-3.5-.7-.3-12.9-.3-12.9 5.1-4.4c9.8-8.5 9.5-6.7 9.8-54.2.3-41.7-1.1-92.8-2.8-103.6-1.9-11.9-8.9-21.2-19.5-26-4.2-1.9-8.1-2.7-18.2-3.4C165.9 2.6 99 2 75.2 3m91.4 43.5c2.2.9 3.9 2.6 4.8 4.7 1.4 3.2 1.3 4.5-.7 8.6-2.5 5.1-3.1 5.2-52.6 5.2-26.2 0-47-.4-48.4-.9-8.3-3.2-9-13.6-1.2-17.9 1.4-.8 16.6-1.1 48.3-1.2 38.4 0 46.9.2 49.8 1.5m-45.1 49.9c3.9 1.7 5.5 4.2 5.5 8.8 0 3.6-2.2 6.9-5.7 8.7-2.7 1.4-48 1.5-51.6.2-8.3-3.2-9-13.6-1.2-17.9 3.2-1.8 48.7-1.6 53 .2M195 210v12h-78c-83.4 0-83.3 0-85.9-4.8-1.5-2.8-1.4-11.1.2-14.2 2.4-4.9 3-4.9 86-4.9l77.7-.1z"/></svg>`;
    },
    blankPage: (color: string): string => {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 240"><path fill="${ color }" d="M91.5 22.7c-15.3.3-44.7 2.2-52.8 3.3-15.4 2.2-24.9 11.4-27.6 26.6-5.6 32.2-4.7 132.9 1.5 151.6 3.3 10.1 13.6 17.8 26.4 19.7 33.7 5.2 146.9 4.5 168-.9 5.4-1.4 12.6-6.4 16-11.1 3.8-5.3 5.6-11.6 7-24.4 1.5-13.5 3.1-66.3 2.3-74.8l-.6-6.7h-19.6c-24.4 0-34.8-1.1-41.6-4.5-9.1-4.4-15.8-12.4-19-22.6-1.4-4.3-1.9-10.6-2.2-30.5l-.5-25.1-10.6-.7c-9.8-.6-19.4-.6-46.7.1"/><path fill="${ color }" d="M163 32.2c0 4 .5 15.2 1 24.9.9 19.3 2.1 23.5 7.7 27.9 5.9 4.6 8.8 5.2 33.6 6.3 13 .5 24 .7 24.3.4 1-.9-5.3-12.1-11.6-20.7-7.8-10.6-26.3-29-36.1-35.9-7.5-5.3-16-10.1-17.9-10.1-.6 0-1 2.9-1 7.2"/></svg>`;
    },
    ...
    minusCircleIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 146 146" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M72.613,0.004c-40.101,0 -72.605,32.504 -72.605,72.604c0,40.1 32.505,72.605 72.605,72.605c40.1,-0.001 72.604,-32.505 72.604,-72.605c-0,-40.1 -32.509,-72.604 -72.604,-72.604Zm34.975,80.583l-69.959,-0.004c-4.396,0 -7.975,-3.579 -7.975,-7.975c0,-4.396 3.575,-7.975 7.975,-7.975l69.971,0.004c2.133,0 4.133,0.83 5.642,2.338c1.5,1.504 2.333,3.508 2.329,5.637c-0.008,4.4 -3.588,7.975 -7.983,7.975Z" /></svg>`;
    },
    closeCircleIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 609 609" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" ><path fill="${color}" d="M302.554,0.017c167.063,-0 302.517,135.433 302.517,302.516c-0,167.084 -135.434,302.517 -302.517,302.521c-167.083,0 -302.521,-135.437 -302.521,-302.521c0,-167.083 135.434,-302.516 302.521,-302.516Zm-0.013,255.545l-79.603,-79.594c-6.284,-6.284 -14.622,-9.731 -23.511,-9.734c-8.851,0.011 -17.209,3.461 -23.47,9.746c-12.94,12.987 -12.926,34.068 0.023,47.017l79.565,79.556l-79.566,79.557c-12.964,12.964 -12.952,34.042 -0,46.993c12.951,12.952 34.041,12.952 46.993,0l79.569,-79.56l79.57,79.56c12.952,12.952 34.041,12.952 46.993,0c12.952,-12.951 12.964,-34.029 -0,-46.993l-79.567,-79.557l79.565,-79.556c12.949,-12.949 12.964,-34.03 0.024,-47.017c-6.261,-6.285 -14.62,-9.735 -23.47,-9.746c-8.889,0.003 -17.227,3.45 -23.512,9.734l-79.603,79.594Z"/></svg>`;
    },
    ...
    darkMoon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 9449 9949" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"><path fill="${color}" d="M9241.78,6988.91c62.468,-15.546 128.26,6.832 168.294,57.242c40.035,50.411 46.932,119.561 17.642,176.886c-824.243,1617.09 -2505.43,2725.63 -4443.49,2725.63c-2750.87,-0 -4984.22,-2233.35 -4984.22,-4984.22c0,-2589.34 1978.78,-4720.16 4505.35,-4961.47c64.115,-6.035 125.844,25.943 157.898,81.796c32.055,55.854 28.524,125.285 -9.032,177.598c-508.86,710.577 -808.494,1580.98 -808.494,2520.81c0,2393.3 1943.06,4336.36 4336.36,4336.36c365.503,-0 720.506,-45.319 1059.69,-130.638Z"/></svg>`;
    },
    lightSun: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 2126 2126" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" xmlns:serif="http://www.serif.com/"><rect id="Artboard1" x="0" y="0" width="2125.98" height="2125.98" style="fill:none;"/><clipPath id="_clip1"><rect x="0" y="0" width="2125.98" height="2125.98"/></clipPath><g clip-path="url(#_clip1)"><path fill="${ color}" d="M1062.99,532.642c292.708,0 530.35,237.642 530.35,530.35c-0,292.708 -237.642,530.35 -530.35,530.35c-292.708,-0 -530.35,-237.642 -530.35,-530.35c0,-292.708 237.642,-530.35 530.35,-530.35Zm116.072,-420.031l0,167.131c0,62.152 -50.459,112.611 -112.611,112.611c-62.151,0 -112.61,-50.459 -112.61,-112.611l-0,-167.131c-0,-62.152 50.459,-112.611 112.61,-112.611c62.152,0 112.611,50.459 112.611,112.611Zm-232.144,1900.76l-0,-167.131c-0,-62.152 50.459,-112.611 112.611,-112.611c62.151,0 112.611,50.459 112.611,112.611l-0,167.131c-0,62.152 -50.46,112.611 -112.611,112.611c-62.152,0 -112.611,-50.459 -112.611,-112.611Zm-834.309,-1066.45l167.131,-0c62.152,-0 112.611,50.459 112.611,112.611c0,62.151 -50.459,112.611 -112.611,112.611l-167.131,-0c-62.152,-0 -112.611,-50.46 -112.611,-112.611c-0,-62.152 50.459,-112.611 112.611,-112.611Zm1900.76,232.144l-167.131,0c-62.152,0 -112.611,-50.459 -112.611,-112.611c0,-62.151 50.459,-112.61 112.611,-112.61l167.131,-0c62.152,-0 112.611,50.459 112.611,112.61c0,62.152 -50.459,112.611 -112.611,112.611Zm-1540.33,-870.168l118.179,118.179c43.948,43.948 43.948,115.308 0,159.256c-43.948,43.948 -115.308,43.948 -159.256,0l-118.179,-118.179c-43.948,-43.948 -43.948,-115.309 -0,-159.256c43.948,-43.948 115.308,-43.948 159.256,-0Zm1179.89,1508.19l-118.18,-118.18c-43.948,-43.948 -43.948,-115.308 -0,-159.256c43.948,-43.948 115.308,-43.948 159.256,0l118.18,118.18c43.947,43.948 43.947,115.308 -0,159.256c-43.948,43.947 -115.309,43.947 -159.256,-0Zm-0,-1508.19c43.947,-43.948 115.308,-43.948 159.256,-0c43.947,43.947 43.947,115.308 -0,159.256l-118.18,118.179c-43.948,43.948 -115.308,43.948 -159.256,0c-43.948,-43.948 -43.948,-115.308 -0,-159.256l118.18,-118.179Zm-1179.89,1508.19c-43.948,43.947 -115.308,43.947 -159.256,-0c-43.948,-43.948 -43.948,-115.308 -0,-159.256l118.179,-118.18c43.948,-43.948 115.308,-43.948 159.256,0c43.948,43.948 43.948,115.308 0,159.256l-118.179,118.18Z"/></g></svg>`;
    },
    paletteIcon: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 3125 3125" xmlns="http://www.w3.org/2000/svg"><path fill="${color}" d="M25.001,1577.92l-0,-2.378c1.306,-863.3 713.695,-1563.79 1590.97,-1563.79c783.447,0 1484.03,651.944 1484.03,1288.98c0,281.411 -257.343,481.218 -508.962,481.218l-506.437,0c-132.364,0 -300.399,100.015 -300.399,327.376c0,227.361 109.591,266.238 262.743,342.433c113.423,54.595 191.782,170.642 191.782,304.847c0,128.84 -72.219,240.945 -178.349,298.008c-86.475,51.576 -276.176,70.385 -444.406,70.385c-877.267,0 -1589.65,-693.002 -1590.97,-1547.08Zm979.596,-684.468c-184.885,-0 -334.989,150.103 -334.989,334.988c0,184.886 150.104,334.989 334.989,334.989c184.885,-0 334.988,-150.103 334.988,-334.989c0,-184.885 -150.103,-334.988 -334.988,-334.988Zm1000.7,-338.114c-186.61,0 -338.114,151.504 -338.114,338.114c0,186.61 151.504,338.113 338.114,338.113c186.61,0 338.113,-151.503 338.113,-338.113c0,-186.61 -151.503,-338.114 -338.113,-338.114Zm-1000.7,1346.14c-128.986,0 -233.706,104.72 -233.706,233.706c0,128.985 104.72,233.705 233.706,233.705c128.986,0 233.705,-104.72 233.705,-233.705c0,-128.986 -104.719,-233.706 -233.705,-233.706Z"/></svg>`;
    },
    ...
    closeIcon2: function (color: string): string {
      return `<svg width="100%" height="100%" viewBox="0 0 135 135" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/"><path fill="${ color }" d="M86.756,67.121l43.407,43.403c5.419,5.426 5.418,14.21 0.002,19.63c-2.708,2.714 -6.267,4.07 -9.82,4.07c-3.554,0 -7.114,-1.357 -9.817,-4.067l-43.402,-43.402l-43.396,43.396c-2.709,2.715 -6.269,4.072 -9.823,4.072c-3.554,-0 -7.113,-1.356 -9.821,-4.071c-5.418,-5.427 -5.415,-14.211 0.004,-19.63l43.402,-43.398l-43.402,-43.402c-5.42,-5.42 -5.42,-14.214 0,-19.635c5.421,-5.421 14.223,-5.418 19.635,0l43.398,43.401l43.402,-43.402c5.421,-5.421 14.221,-5.418 19.636,0.001c5.419,5.421 5.419,14.213 -0.001,19.633l-43.401,43.398Z"/></svg>`;
    },
    ...
    checkBox: function (color: string, back: string | null = null, activeColor: string = ""): string {
      ...
      const checkColorList: Array<string> = [
        AbstractNode.colorExtended.mint,
        ...
        AbstractNode.colorExtended.ahhopeBlue,
        AbstractNode.colorExtended.ahhopeBlueLight,
        AbstractNode.colorExtended.ahhopeBlueDark,
        AbstractNode.colorExtended.ahhopeBlueFocus,
      ];
      let uncheck: boolean;
    ...
    centerAlign: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 709.000000 709.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,709) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M1803 4857 c-59 -14 -108 -62 -126 -124 -27 -89 9 -178 88 -221 28 -16 172 -17 1763 -20 1159 -1 1746 1 1772 8 68 18 130 110 130 190 -1 71 -66 148 -145 169 -54 15 -3421 13 -3482 -2z"/><path fill="${ color }" d="M2550 3727 c-53 -18 -88 -49 -111 -103 -40 -90 -8 -191 76 -237 l40 -22 985 -3 985 -2 45 22 c78 40 121 132 98 211 -17 57 -45 95 -93 120 l-40 22 -975 2 c-714 1 -985 -2 -1010 -10z"/><path fill="${ color }" d="M2175 2603 c-30 -8 -84 -52 -105 -86 -63 -104 -9 -244 107 -276 57 -16 2698 -15 2744 1 90 31 135 103 126 200 -6 66 -35 110 -96 143 -35 20 -56 20 -1396 21 -748 1 -1369 0 -1380 -3z"/></g></svg>`;
    },
    leftAlign: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 709.000000 709.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,709) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M3504 4860 l-1730 -5 -35 -29 c-66 -55 -89 -130 -64 -206 19 -57 67 -104 122 -119 52 -15 3453 -15 3505 -1 45 13 103 75 117 127 14 48 14 60 -2 103 -28 78 -66 111 -143 127 -22 4 -818 6 -1770 3z"/><path fill="${ color }" d="M1805 3727 c-105 -31 -157 -118 -133 -225 13 -62 63 -114 125 -131 53 -15 2341 -15 2380 0 45 17 91 69 109 122 14 42 14 55 3 95 -17 62 -45 99 -94 125 l-40 22 -1155 2 c-852 1 -1165 -2 -1195 -10z"/><path fill="${ color }" d="M1800 2596 c-106 -34 -158 -132 -124 -235 19 -60 66 -105 123 -121 27 -7 469 -9 1393 -8 l1354 3 42 28 c61 40 86 95 79 174 -6 79 -39 123 -115 152 -52 21 -61 21 -1385 20 -971 -1 -1341 -4 -1367 -13z"/></g></svg>`;
    },
    rightAlign: (color: string): string => {
      return `<svg width="100%" height="100%" viewBox="0 0 709.000000 709.000000" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,709) scale(0.1,-0.1)" fill="#000000"><path fill="${ color }" d="M1785 4859 c-42 -12 -84 -54 -107 -107 -40 -90 -4 -188 88 -236 39 -21 42 -21 1754 -24 1214 -2 1728 1 1759 8 93 23 147 102 138 201 -6 73 -40 119 -107 148 l-49 21 -1723 -1 c-965 0 -1736 -5 -1753 -10z"/><path fill="${ color }" d="M2920 3733 c-36 -13 -91 -58 -105 -87 -58 -115 -2 -244 120 -275 65 -16 2292 -15 2349 1 92 27 142 102 133 200 -7 75 -45 126 -113 151 -46 16 -131 17 -1209 16 -638 0 -1167 -3 -1175 -6z"/><path fill="${ color }" d="M2536 2600 c-46 -14 -94 -68 -113 -127 -14 -46 -15 -58 -3 -95 19 -60 48 -96 95 -121 l40 -22 1335 -3 c945 -2 1348 0 1380 8 65 16 108 49 132 100 41 89 7 201 -76 247 -29 17 -110 18 -1396 20 -759 1 -1378 -2 -1394 -7z"/></g></svg>`;
    },
  }
  public svgMaker: Record<string, (...args: any[]) => string> = AbstractNode.svgMaker;
  public static mediaCondition: number[][] = [
    [ Infinity, 1450 ],
    [ 1450, 1100 ],
    [ 1100, 900 ],
    [ 900, 760 ],
  ...
  public static pureNumberProperty: string[] = [
    "fontWeight",
    "zIndex",
    "opacity",
    "lineHeight",
  ...
  private static cloneCachedElement = (
    ...
    const ownerDocument: Document = mother?.ownerDocument ?? document;
    const tagName: string = mode.trim().toLowerCase();
    let documentCache = AbstractNode.elementCache.get(ownerDocument);
    if (documentCache === undefined) {
      documentCache = new Map();
      AbstractNode.elementCache.set(ownerDocument, documentCache);
    }
    let cachedElement = documentCache.get(tagName);
    if (cachedElement === undefined) {
      cachedElement = ownerDocument.createElement(tagName);
      documentCache.set(tagName, cachedElement);
    }
    return cachedElement.cloneNode(false) as HTMLElement;
  }

  public mediaCondition: number[][] = AbstractNode.mediaCondition;
  
  public static mediaStandardWidth = (): number => {
    try {
  ...
  public static mediaConditionToArray = (booleanMode: boolean = false): Array<string | boolean> => {
    const { mediaCondition } = AbstractNode;
    const standardWidth: number = AbstractNode.mediaStandardWidth();
    let conditions: Array<string | boolean>;
    ...
    for (let conditionArr of mediaCondition) {
      ...
      if (standardWidth <= conditionArr[0] && standardWidth > conditionArr[1]) {
  ...
  public static mediaNumber = (bigDesktop: number, desktop: number, smallDesktop: number, tablet: number, mobile: number): number => {
    ...
    const standardWidth: number = AbstractNode.mediaStandardWidth();
    const conditionMatrix: number[][] = AbstractNode.mediaCondition;
    let finalValue: number;
    
    if (standardWidth <= conditionMatrix[0][0] && standardWidth > conditionMatrix[0][1]) {
      finalValue = bigDesktop;
    } else if (standardWidth <= conditionMatrix[1][0] && standardWidth > conditionMatrix[1][1]) {
      finalValue = desktop;
    } else if (standardWidth <= conditionMatrix[2][0] && standardWidth > conditionMatrix[2][1]) {
      finalValue = smallDesktop;
    } else if (standardWidth <= conditionMatrix[3][0] && standardWidth > conditionMatrix[3][1]) {
      finalValue = tablet;
    } else {
      finalValue = mobile;
    }
  ...
  public static createNode = (mode: DomCommand): HTMLElement | SvgDom => {
    if (mode.mode === "svg") {
      return AbstractNode.createSvg(mode as DomCommand);
    } else {
      return AbstractNode.createDom(mode as DomCommand);
    }
  }

  public static createDom = (domCommandObject: DomCommand): HTMLElement => {
    if (typeof domCommandObject !== "object" || domCommandObject === null) {
      throw new Error("invalid input");
    }
    let dom_clone: HTMLElement;
    let targetStyle: DomStyle;
    let tempIndex: number | null;
    let boldObject: string, underObject: string, specialObject: string, codeObject: string, italicObject: string, strikeObject: string;
    let referenceObject: string, anchorObject: string;
    let children: DomCommand[];
    let nextObject: DomCommand | null;
    let previousObject: DomCommand | null;
    let previousDom: HTMLElement | SvgDom;
    let thisEa: string;
    let codeArr: string[];
    let thisCodeRegExp: RegExp;
    let thisExecResult: RegExpExecArray | null;
    let codeDomArr: HTMLElement[];
    let sourceBoo: boolean;
    let mode: string;
    let mother: HTMLElement | Element | SVGElement | null;
    let source: string;
    let text: string;
    let thisTempStyleClassName: string;
    let thisStyleKey: string;
    let thisOriginStyleKey: string;
    let styleElement: HTMLStyleElement | null;
    let targetStyleMaker: (targetStyle: DomStyle) => DomStyle;

    thisEa = AbstractNode.mediaEa();
    children = [];
    targetStyle = {};
    nextObject = null;
    previousObject = null;
    ...
    if (domCommandObject.mode === undefined) {
      mode = "abstract-div";
    } else {
      mode = domCommandObject.mode;
    }
    if (domCommandObject.source !== undefined) {
      source = domCommandObject.source;
    }
    if (domCommandObject.mother !== undefined) {
      mother = domCommandObject.mother;
    }

    children = [];
    if (domCommandObject.child !== undefined) {
      if (typeof domCommandObject.child === "object" && domCommandObject.child !== null && !Array.isArray(domCommandObject.child)) {
        children.push(domCommandObject.child);
      }
    }
    if (domCommandObject.children !== undefined) {
      if (Array.isArray(domCommandObject.children)) {
        children = children.concat(domCommandObject.children);
      }
    }
    if (domCommandObject.next !== undefined) {
      if (typeof domCommandObject.next === "object" && domCommandObject.next !== null && !Array.isArray(domCommandObject.next)) {
        nextObject = domCommandObject.next;
      }
    }
    if (domCommandObject.previous !== undefined) {
      if (typeof domCommandObject.previous === "object" && domCommandObject.previous !== null && !Array.isArray(domCommandObject.previous)) {
        previousObject = domCommandObject.previous;
      }
    }

    dom_clone = AbstractNode.cloneCachedElement(mode, mother);

    // text
    if (domCommandObject.text !== undefined) {
      if ((typeof domCommandObject.text === "string" || Array.isArray(domCommandObject.text)) && dom_clone.textContent !== undefined) {
        ...
        if (/\<b\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.bold === undefined || typeof domCommandObject.bold !== "object") {
            ...
            if (domCommandObject.bold.position === undefined || domCommandObject.bold.position === null) {
              domCommandObject.bold.position = "relative";
            }
            for (let b in domCommandObject.bold) {
              if (b === "color") {
                boldObject += "color:" + domCommandObject.bold[ b ] + ";";
              } else if (b === "fontColor") {
                boldObject += "color:" + domCommandObject.bold[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.bold[ "background" ];
                delete domCommandObject.bold[ "color" ];
                boldObject += "background:" + domCommandObject.bold[ b ] + ";";
                boldObject += "background-clip:" + "text" + ";";
                boldObject += "-webkit-background-clip:" + "text" + ";";
                boldObject += "color:" + "transparent" + ";";
              } else {
                boldObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                boldObject += ':';
                if (typeof domCommandObject.bold[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    boldObject += String(domCommandObject.bold[ b ]);
                  } else {
                    boldObject += String(domCommandObject.bold[ b ]) + thisEa;
                  }
                } else {
                  boldObject += domCommandObject.bold[ b ];
                }
                boldObject += ';';
              }
            }
        ...
        if (/\<u\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.under === undefined || typeof domCommandObject.under !== "object") {
            ...
            if (domCommandObject.under.position === undefined || domCommandObject.under.position === null) {
              domCommandObject.under.position = "relative";
            }
            for (let b in domCommandObject.under) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.under[ b ] as [string | number, string | number];
                ...
                underObject += "color:" + domCommandObject.under[ b ] + ";";
              } else if (b === "fontColor") {
                underObject += "color:" + domCommandObject.under[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.under[ "background" ];
                delete domCommandObject.under[ "color" ];
                underObject += "background:" + domCommandObject.under[ b ] + ";";
                underObject += "background-clip:" + "text" + ";";
                underObject += "color:" + "transparent" + ";";
              } else {
                underObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                underObject += ':';
                if (typeof domCommandObject.under[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    underObject += String(domCommandObject.under[ b ]);
                  } else {
                    underObject += String(domCommandObject.under[ b ]) + thisEa;
                  }
                } else {
                  underObject += domCommandObject.under[ b ];
                }
                underObject += ';';
              }
            }
        ...
        if (/\<s\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.special === undefined || typeof domCommandObject.special !== "object") {
            ...
            if (domCommandObject.special.position === undefined || domCommandObject.special.position === null) {
              domCommandObject.special.position = "relative";
            }
            for (let b in domCommandObject.special) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.special[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                ...
                specialObject += "color:" + domCommandObject.special[ b ] + ";";
              } else if (b === "fontColor") {
                specialObject += "color:" + domCommandObject.special[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.special[ "background" ];
                delete domCommandObject.special[ "color" ];
                specialObject += "background:" + domCommandObject.special[ b ] + ";";
                specialObject += "background-clip:" + "text" + ";";
                specialObject += "color:" + "transparent" + ";";
              } else {
                specialObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                specialObject += ':';
                if (typeof domCommandObject.special[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    specialObject += String(domCommandObject.special[ b ]);
                  } else {
                    specialObject += String(domCommandObject.special[ b ]) + thisEa;
                  }
                } else {
                  specialObject += domCommandObject.special[ b ];
                }
                specialObject += ';';
              }
            }
        ...
        if (/\<c\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.code === undefined || typeof domCommandObject.code !== "object") {
            ...
            if (domCommandObject.code.position === undefined || domCommandObject.code.position === null) {
              domCommandObject.code.position = "relative";
            }
            for (let b in domCommandObject.code) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.code[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                ...
                codeObject += "color:" + domCommandObject.code[ b ] + ";";
              } else if (b === "fontColor") {
                codeObject += "color:" + domCommandObject.code[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.code[ "background" ];
                delete domCommandObject.code[ "color" ];
                codeObject += "background:" + domCommandObject.code[ b ] + ";";
                codeObject += "background-clip:" + "text" + ";";
                codeObject += "color:" + "transparent" + ";";
              } else {
                codeObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                codeObject += ':';
                if (typeof domCommandObject.code[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    codeObject += String(domCommandObject.code[ b ]);
                  } else {
                    codeObject += String(domCommandObject.code[ b ]) + thisEa;
                  }
                } else {
                  codeObject += domCommandObject.code[ b ];
                }
                codeObject += ';';
              }
            }
            ...
            codeArr = [];
            do {
              thisExecResult = thisCodeRegExp.exec(domCommandObject.text as string);
              if (thisExecResult !== null) {
                codeArr.push(thisExecResult[ 1 ]);
              }
            } while (thisExecResult !== null)
            text = text.replace(/(\<code [^\>]*\>)(((?!\<\/code\>).)*)(\<\/code\>)/gi, (match: string, p1: string) => {
              return p1 + "</code>"
            });
        ...
        if (/\<i\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.italic === undefined || typeof domCommandObject.italic !== "object") {
            ...
            if (domCommandObject.italic.position === undefined || domCommandObject.italic.position === null) {
              domCommandObject.italic.position = "relative";
            }
            for (let b in domCommandObject.italic) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.italic[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                ...
                italicObject += "color:" + domCommandObject.italic[ b ] + ";";
              } else if (b === "fontColor") {
                italicObject += "color:" + domCommandObject.italic[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.italic[ "background" ];
                delete domCommandObject.italic[ "color" ];
                italicObject += "background:" + domCommandObject.italic[ b ] + ";";
                italicObject += "background-clip:" + "text" + ";";
                italicObject += "color:" + "transparent" + ";";
              } else {
                italicObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                italicObject += ':';
                if (typeof domCommandObject.italic[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    italicObject += String(domCommandObject.italic[ b ]);
                  } else {
                    italicObject += String(domCommandObject.italic[ b ]) + thisEa;
                  }
                } else {
                  italicObject += domCommandObject.italic[ b ];
                }
                italicObject += ';';
              }
            }
        ...
        if (/\<r\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.reference === undefined || typeof domCommandObject.reference !== "object") {
            ...
            if (domCommandObject.reference.position === undefined || domCommandObject.reference.position === null) {
              domCommandObject.reference.position = "relative";
            }
            for (let b in domCommandObject.reference) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.reference[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                  referenceObject += "font-size:" + String(thisSize) + thisEa;
                  referenceObject += ';';
                } else if (typeof thisSize === "string") {
                  referenceObject += "font-size:" + thisSize;
                  referenceObject += ';';
                }
                if (typeof thisWeight === "number") {
                  referenceObject += "font-weight:" + String(thisWeight);
                  referenceObject += ';';
                } else if (typeof thisWeight === "string") {
                  referenceObject += "font-weight:" + thisWeight;
                  referenceObject += ';';
                }
              } else if (b === "color") {
                referenceObject += "color:" + domCommandObject.reference[ b ] + ";";
              } else if (b === "fontColor") {
                referenceObject += "color:" + domCommandObject.reference[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.reference[ "background" ];
                delete domCommandObject.reference[ "color" ];
                referenceObject += "background:" + domCommandObject.reference[ b ] + ";";
                referenceObject += "background-clip:" + "text" + ";";
                referenceObject += "color:" + "transparent" + ";";
              } else {
                referenceObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                referenceObject += ':';
                if (typeof domCommandObject.reference[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    referenceObject += String(domCommandObject.reference[ b ]);
                  } else {
                    referenceObject += String(domCommandObject.reference[ b ]) + thisEa;
                  }
                } else {
                  referenceObject += domCommandObject.reference[ b ];
                }
                referenceObject += ';';
              }
            }
        ...
        if (/\<a\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.anchor === undefined || typeof domCommandObject.anchor !== "object") {
            ...
            if (domCommandObject.anchor.position === undefined || domCommandObject.anchor.position === null) {
              domCommandObject.anchor.position = "relative";
            }
            for (let b in domCommandObject.anchor) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.anchor[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                  anchorObject += "font-size:" + String(thisSize) + thisEa;
                  anchorObject += ';';
                } else if (typeof thisSize === "string") {
                  anchorObject += "font-size:" + thisSize;
                  anchorObject += ';';
                }
                if (typeof thisWeight === "number") {
                  anchorObject += "font-weight:" + String(thisWeight);
                  anchorObject += ';';
                } else if (typeof thisWeight === "string") {
                  anchorObject += "font-weight:" + thisWeight;
                  anchorObject += ';';
                }
              } else if (b === "color") {
                anchorObject += "color:" + domCommandObject.anchor[ b ] + ";";
              } else if (b === "fontColor") {
                anchorObject += "color:" + domCommandObject.anchor[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.anchor[ "background" ];
                delete domCommandObject.anchor[ "color" ];
                anchorObject += "background:" + domCommandObject.anchor[ b ] + ";";
                anchorObject += "background-clip:" + "text" + ";";
                anchorObject += "color:" + "transparent" + ";";
              } else {
                anchorObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                anchorObject += ':';
                if (typeof domCommandObject.anchor[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    anchorObject += String(domCommandObject.anchor[ b ]);
                  } else {
                    anchorObject += String(domCommandObject.anchor[ b ]) + thisEa;
                  }
                } else {
                  anchorObject += domCommandObject.anchor[ b ];
                }
                anchorObject += ';';
              }
            }
        ...
        if (/\<k\%/gi.test(domCommandObject.text as string)) {
          if (domCommandObject.strike === undefined || typeof domCommandObject.strike !== "object") {
            ...
            if (domCommandObject.strike.position === undefined || domCommandObject.strike.position === null) {
              domCommandObject.strike.position = "relative";
            }
            for (let b in domCommandObject.strike) {
              if (b === "fontSizeWeight") {
                const [ thisSize, thisWeight ] = domCommandObject.strike[ b ] as [string | number, string | number];
                if (typeof thisSize === "number") {
                  strikeObject += "font-size:" + String(thisSize) + thisEa;
                  strikeObject += ';';
                } else if (typeof thisSize === "string") {
                  strikeObject += "font-size:" + thisSize;
                  strikeObject += ';';
                }
                if (typeof thisWeight === "number") {
                  strikeObject += "font-weight:" + String(thisWeight);
                  strikeObject += ';';
                } else if (typeof thisWeight === "string") {
                  strikeObject += "font-weight:" + thisWeight;
                  strikeObject += ';';
                }
              } else if (b === "color") {
                strikeObject += "color:" + domCommandObject.strike[ b ] + ";";
              } else if (b === "fontColor") {
                strikeObject += "color:" + domCommandObject.strike[ b ] + ";";
              } else if (b === "textGradient") {
                delete domCommandObject.strike[ "background" ];
                delete domCommandObject.strike[ "color" ];
                strikeObject += "background:" + domCommandObject.strike[ b ] + ";";
                strikeObject += "background-clip:" + "text" + ";";
                strikeObject += "color:" + "transparent" + ";";
              } else {
                strikeObject +=
                  /([a-z]+)([A-Z][a-z]+)/g.test(b) ?
                    b.replace(/([a-z]+)([A-Z][a-z]+)/g, (match, p1, p2) => (p1 + "-" + p2.toLowerCase())) :
                    b;
                strikeObject += ':';
                if (typeof domCommandObject.strike[ b ] === "number") {
                  if (AbstractNode.pureNumberProperty.includes(b)) {
                    strikeObject += String(domCommandObject.strike[ b ]);
                  } else {
                    strikeObject += String(domCommandObject.strike[ b ]) + thisEa;
                  }
                } else {
                  strikeObject += domCommandObject.strike[ b ];
                }
                strikeObject += ';';
              }
            }
        ...
        if (mode !== "textarea") {
          dom_clone.insertAdjacentHTML("beforeend", text.replace(/\n/g, "<br>"));
          ...
          dom_clone.textContent = text.replace(/\<br\>/g, "\n");
        }
      }
    }
    ...
    if (typeof domCommandObject.source === "string") {
      dom_clone.setAttribute("src", domCommandObject.source);
    }

    // class — 항목마다 classList.add: 빈 문자열·공백만 있는 토큰은 DOM 규격상 거부됨
    if (domCommandObject.class !== undefined) {
      if (Array.isArray(domCommandObject.class)) {
        for (let c of domCommandObject.class) {
          if (typeof c === "string" && c.trim() !== "") {
            dom_clone.classList.add(c.trim());
          }
        }
      }
    }
    ...
    // id
    if (domCommandObject.id !== undefined) {
      if (typeof domCommandObject.id === "string" && dom_clone.id !== undefined) {
        dom_clone.id = domCommandObject.id;
      }
    }

    // attribute
    if (/textarea/gi.test(mode)) {
      if (domCommandObject.attribute === undefined) {
        domCommandObject.attribute = {
          spellcheck: "false",
        }
      } else {
        domCommandObject.attribute.spellcheck = "false";
      }
    }
    if (/img/gi.test(mode)) {
      if (domCommandObject.attribute === undefined) {
        domCommandObject.attribute = {
          alt: "img default description",
        }
      } else {
        if (typeof domCommandObject.attribute.alt !== "string") {
          domCommandObject.attribute.alt = "img default description";
        }
      }
    }
    if (domCommandObject.attribute !== undefined) {
      if (typeof domCommandObject.attribute === "object" && domCommandObject.attribute !== null) {
        for (let key in domCommandObject.attribute) {
          dom_clone.setAttribute(key, String(domCommandObject.attribute[ key ]));
        }
      }
    }

    // style
    if (domCommandObject.style !== undefined) {
      if (typeof domCommandObject.style === "object") {
        targetStyle = domCommandObject.style;
      } else {
    ...
    if (typeof targetStyle.transformOrigin !== "string") {
      targetStyle.transformOrigin = "50% 50%";
    }
    ...
    for (let key in targetStyle) {
      if (
        typeof targetStyle[ key ] === "string" &&
        /;+$/gi.test(targetStyle[ key ])
      ) {
        targetStyle[ key ] = targetStyle[ key ].replace(/;+$/gi, "");
      }
    }

    targetStyleMaker = (targetStyle: DomStyle) => {
      if (targetStyle.textGradient !== undefined) {
        delete targetStyle.background;
        delete targetStyle.color;
        targetStyle.background = String(targetStyle.textGradient);
        targetStyle[ "background-clip" ] = "text";
        targetStyle[ "-webkit-background-clip" ] = "text";
        targetStyle[ "color" ] = "transparent";
        delete targetStyle.textGradient;
      }
      if (targetStyle.fontColor !== undefined) {
        targetStyle.color = String(targetStyle.fontColor);
        delete targetStyle[ "fontColor" ];
      }
      for (let i in targetStyle) {
        if (typeof targetStyle[ i ] === "number") {
          if (AbstractNode.pureNumberProperty.includes(i)) {
            targetStyle[ i ] = String(targetStyle[ i ]);
          } else {
            targetStyle[ i ] = String(targetStyle[ i ]) + thisEa;
          }
        } else {
          if (i === "widthHeight") {
            const [ thisWidth, thisHeight ] = targetStyle[ i ] as [string | number, string | number];
            if (typeof thisWidth === "number") {
              targetStyle.width = String(thisWidth) + thisEa;
            } else if (typeof thisWidth === "string") {
              targetStyle.width = thisWidth;
            }
            if (typeof thisHeight === "number") {
              targetStyle.height = String(thisHeight) + thisEa;
            } else if (typeof thisHeight === "string") {
              targetStyle.height = thisHeight;
            }
          } else if (i === "fontSizeWeight") {
            const [ thisSize, thisWeight ] = targetStyle[ i ] as [string | number, string | number];
            if (typeof thisSize === "number") {
              targetStyle.fontSize = String(thisSize) + thisEa;
            } else if (typeof thisSize === "string") {
              targetStyle.fontSize = thisSize;
            }
            if (typeof thisWeight === "number") {
              targetStyle.fontWeight = String(thisWeight);
            } else if (typeof thisWeight === "string") {
              targetStyle.fontWeight = thisWeight;
            }
          } else {
            targetStyle[ i ] = targetStyle[ i ];
          }
        }
      }
      return targetStyle;
    }
    targetStyle = targetStyleMaker(targetStyle);

    // event
    if (domCommandObject.event !== undefined) {
      if (typeof domCommandObject.event === "object" && domCommandObject.event !== null) {
        for (let type in domCommandObject.event) {
          if (typeof domCommandObject.event[ type ] === "function") {
            if (type === "touch") {
              let isIOS: boolean = false;
              try {
                isIOS = /iPhone|iPad|iPod/.test(window.navigator.userAgent) || (window.navigator.userAgent.includes("Macintosh") && window.navigator.maxTouchPoints > 1);
              } catch { }
              if (isIOS) {
                const handler = domCommandObject.event![ type ];
                let tapStartX = 0;
                let tapStartY = 0;
                let tapStartTime = 0;

                dom_clone.addEventListener("pointerdown", (e: PointerEvent) => {
                  if (e.button !== 0) {
                    return;
                  }
                  tapStartX = e.clientX;
                ...
                dom_clone.addEventListener("pointerup", (e: PointerEvent) => {
                  if (e.button !== 0 || tapStartTime === 0) {
                    return;
                  }
                  const moved = Math.hypot(e.clientX - tapStartX, e.clientY - tapStartY);
                  if (moved < 10 && Date.now() - tapStartTime < 500) {
                    handler(e);
                  }
                  tapStartTime = 0;
                });

                dom_clone.addEventListener("pointercancel", () => {
                  tapStartTime = 0;
                });
              } else {
                dom_clone.addEventListener("click", domCommandObject.event[ type ]);
              }
            } else if (type === "hover") {
              dom_clone.setAttribute("origin_style", JSON.stringify(targetStyle));
              dom_clone.addEventListener("mouseenter", domCommandObject.event[ type ]);
              dom_clone.addEventListener("mouseleave", (e: MouseEvent) => {
                const self = e.currentTarget as HTMLElement;
                const originStyle: DomStyle = JSON.parse(self.getAttribute("origin_style") as string);
                for (let i in originStyle) {
                  thisOriginStyleKey = i;
                  if (typeof originStyle[ i ] === "number") {
                    if (AbstractNode.pureNumberProperty.includes(i)) {
                      (self.style as any)[ i ] = String(originStyle[ i ]);
                    } else {
                      self.style[ thisOriginStyleKey ] = String(originStyle[ i ]) + thisEa;
                    }
                  } else {
                    self.style[ thisOriginStyleKey ] = String(originStyle[ i ]);
                  }
                }
              });
            } else {
              if (/\$/gi.test(type)) {
                ...
                for (let t of allTypes) {
                  if (t === "touch") {
                    ...
                    dom_clone.addEventListener(t, domCommandObject.event[ type ]);
                  }
                }
              } else {
                dom_clone.addEventListener(type, domCommandObject.event[ type ]);
              }
            }
            if (type === "click") {
              if (typeof targetStyle.cursor !== "string") {
    ...
    if (mother !== null && typeof mother.appendChild === "function") {
      if (
        domCommandObject.unshift === true ||
        (
          typeof domCommandObject.position === "number" &&
          domCommandObject.position >= 0
        )
      ) {
        try {
          ...
          if (motherChildren.length > 0) {
            if (
              ...
              if (domCommandObject.position < motherChildren.length && motherChildren[ domCommandObject.position ] !== undefined) {
                mother.insertBefore(dom_clone, motherChildren[ domCommandObject.position ]);
              } else {
                if (domCommandObject.unshift === true) {
                  mother.insertBefore(dom_clone, motherChildren[ 0 ]);
                } else {
    ...
    if (typeof previousObject === "object" && previousObject !== null && !Array.isArray(previousObject)) {
      if (mother !== null) {
        if (previousObject.pass === true) {
          // pass
        } else {
          previousObject.mother = mother;
          previousDom = AbstractNode.createNode(previousObject) as HTMLElement | SvgDom;
          if (previousDom instanceof SvgDom) {
            mother.insertBefore(previousDom.source, dom_clone);
          } else {
    ...
    // video mode
    if (mode === "video") {
      (dom_clone as HTMLVideoElement).autoplay = false;
      (dom_clone as HTMLVideoElement).loop = false;
      (dom_clone as HTMLVideoElement).muted = true;
      (dom_clone as HTMLVideoElement).playsInline = true;
      (dom_clone as HTMLVideoElement).controls = false;
      if (domCommandObject.attribute !== undefined) {
        if (typeof domCommandObject.attribute === "object" && domCommandObject.attribute !== null) {
          if (typeof domCommandObject.attribute.autoplay === "string" && domCommandObject.attribute.autoplay !== "false") {
            (dom_clone as HTMLVideoElement).autoplay = true;
          }
          if (typeof domCommandObject.attribute.loop === "string" && domCommandObject.attribute.loop !== "false") {
            (dom_clone as HTMLVideoElement).loop = true;
          }
          if (
            (typeof domCommandObject.attribute.controls === "string" && domCommandObject.attribute.controls !== "false")
            || (typeof domCommandObject.attribute.control === "string" && domCommandObject.attribute.control !== "false")
          ) {
            (dom_clone as HTMLVideoElement).controls = true;
          }
          if (typeof domCommandObject.attribute.muted === "string" && domCommandObject.attribute.muted === "false") {
            (dom_clone as HTMLVideoElement).muted = false;
          }
        }
      }
    }

    return dom_clone as HTMLElement;
  }

  public static createSvg = (domCommandObject: DomCommand): SvgDom => {
    if (typeof domCommandObject !== "object" || domCommandObject === null) {
      throw new Error("invalid input");
    }
    let dom_clone: SvgDom;
    let targetStyle: DomStyle;
    let tempIndex: number | null;
    let children: DomCommand[];
    let nextObject: DomCommand | null;
    let previousObject: DomCommand | null;
    let previousDom: HTMLElement | SVGElement;
    let thisEa: string;
    let codeArr: string[];
    let thisCodeRegExp: RegExp;
    let thisExecResult: RegExpExecArray | null;
    ...
    // source
    if (domCommandObject.source === undefined) {
      throw new Error("must be in source");
    }
    source = domCommandObject.source as string;
    ...
    // id
    if (domCommandObject.id !== undefined) {
      if (typeof domCommandObject.id === "string") {
        dom_clone.setId(domCommandObject.id);
      }
    }
    ...
    for (let i in targetStyle) {
      if (typeof targetStyle[ i ] === "number") {
        if (AbstractNode.pureNumberProperty.includes(i)) {
          dom_clone.setStyle(i, String(targetStyle[ i ]));
        } else {
          dom_clone.setStyle(i, String(targetStyle[ i ]) + thisEa);
        }
      } else {
        dom_clone.setStyle(i, String(targetStyle[ i ]));
      }
          ...
          if (typeof domCommandObject.event[ type ] === "function") {
            if (type === "touch") {
              if (/iPhone/gi.test(window.navigator.userAgent)) {
                dom_clone.addEventListener("touchstart", domCommandObject.event[ type ]);
              } else {
                dom_clone.addEventListener("click", domCommandObject.event[ type ]);
              }
            } else if (type === "hover") {
              ...
              dom_clone.addEventListener("mouseenter", domCommandObject.event[ type ]);
              dom_clone.addEventListener("mouseleave", (e: MouseEvent) => {
                const self = e.currentTarget as SVGElement;
                const originStyle: DomStyle = JSON.parse(self.getAttribute("origin_style") as string);
                for (let i in originStyle) {
                  thisOriginStyleKey = i;
                  if (typeof originStyle[ i ] === "number") {
            ...
            if (type === "click") {
              dom_clone.setStyle("cursor", "pointer");
            }
          }
        }
      }
        ...
        try {
          ...
          if (motherChildren.length > 0) {
            if (
              ...
              if (domCommandObject.position < motherChildren.length && motherChildren[ domCommandObject.position ] !== undefined) {
                mother.insertBefore(dom_clone.source, motherChildren[ domCommandObject.position ]);
              } else {
                if (domCommandObject.unshift === true) {
                  mother.insertBefore(dom_clone.source, motherChildren[ 0 ]);
                } else {
                  mother.appendChild(dom_clone.source);
                }
              }
            } else {
              if (domCommandObject.unshift === true) {
    ...
    if (typeof previousObject === "object" && previousObject !== null && !Array.isArray(previousObject)) {
      if (mother !== null) {
        previousObject.mother = mother;
        previousDom = AbstractNode.createNode(previousObject) as HTMLElement | SVGElement;
        mother.insertBefore(previousDom, dom_clone.source);
      }
    }
  ...
  public static withOut = (percent: number | string, num?: string | number, ea?: string): string => {
    ...
    } else if (typeof percent === "string" && typeof num === "number" && ea === undefined) {
      return ("calc(" + percent + " - " + String(num) + thisEa + ")");
    } else {
      throw new Error("invaild arguments");
    }
  }
  ...
  public static pixelUnit = (num: number | string): string => {
  ...
  public static setThrottle = (callback: () => unknown, ms: number = 100): () => void => {
  ...
  public mediaConditionToArray (): Array<string | boolean> {
  ...
  public createNode(domCommandObject: DomCommand): HTMLElement | SvgDom {
    return AbstractNode.createNode(domCommandObject);
  }

  public createDom (domCommandObject: DomCommand): HTMLElement {
    return AbstractNode.createDom(domCommandObject);
  }

  public createSvg (domCommandObject: DomCommand): SvgDom {
  ...
  public pixelUnit (num: number | string): string {
  ...
  public cssCalc (x: string | number, mode: string, y: string | number): string {
    return AbstractNode.cssCalc(x, mode, y);
  }

  public setThrottle (callback: () => unknown, ms: number = 100): () => void {
