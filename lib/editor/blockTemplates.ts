    ...
    templates: [
      {
        ...
        html: '<blockquote class="info-box" data-variant="info"><h2>참고</h2><p>중요한 정보를 여기에 작성하세요.</p></blockquote>',
      },
      {
        id: 'tip-box',
        label: '팁',
        ...
        html: '<blockquote class="info-box" data-variant="tip"><h2>팁</h2><p>유용한 요령을 적어 보세요.</p></blockquote>',
      },
      {
        id: 'warning-box',
        label: '주의',
        ...
        html: '<blockquote class="info-box" data-variant="warning"><h2>주의</h2><p>실수하기 쉬운 점을 적어 보세요.</p></blockquote>',
      },
      {
        id: 'example-box',
        label: '예시',
        ...
        html: '<blockquote class="info-box" data-variant="example"><h2>예시</h2><p>예시 내용을 작성하세요.</p></blockquote>',
      },
    ],
  },
  {
    ...
    templates: [
      {
        id: 'table-2x2',
        label: '2×2 표',
        html: '<table class="epub-table"><tbody><tr><th><p> </p></th><th><p> </p></th></tr><tr><td><p> </p></td><td><p> </p></td></tr></tbody></table>',
      },
      {
        id: 'table-compare',
        label: '비교 2열',
        description: '항목 / 내용',
        html: '<table class="epub-table"><thead><tr><th>항목</th><th>내용</th></tr></thead><tbody><tr><td>A</td><td><p> </p></td></tr><tr><td>B</td><td><p> </p></td></tr></tbody></table>',
      },
      {
        id: 'table-schedule',
        label: '3열 일정',
        html: '<table class="epub-table"><thead><tr><th>단계</th><th>설명</th><th>비고</th></tr></thead><tbody><tr><td>1</td><td><p> </p></td><td><p> </p></td></tr><tr><td>2</td><td><p> </p></td><td><p> </p></td></tr><tr><td>3</td><td><p> </p></td><td><p> </p></td></tr></tbody></table>',
      },
    ],
  },
  {
